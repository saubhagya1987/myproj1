			...
			<section class="common_footer_actions">
				<div id="main_actions" class="clearfix">
					<ul class="reset clearfix fr btn_grup3">
						<li class="fl list"><a style="cursor:pointer;" href="#" class="anch save saveCfsSuccessionReadinessLink" ><span class="txt">Save</span></a></li>
						<li class="fl list"><a onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/${partyId}/<%=request.getSession().getAttribute("headerName")%>/2');" class="anch cancel"><span class="txt">Cancel</span></a></li>
					...
					<ul class="reset clearfix fr btn_grup2">
						<li class="fl list"><a href="#" onclick="uploadNote(${partyId},'/partner/datacollection/succession-readiness/${partyId}');" class="anch add_note"><span class="txt">Notes</span></a></li>						
						<li class="fl list"><a href="#" onclick="uploadDocument(${partyId},'/partner/datacollection/succession-readiness/${partyId}');" class="anch add_doc"><span class="txt">Documents</span></a></li>
					</ul>
					<ul class="reset clearfix fl btn_grup1">
						<li class="fl list ${isDataSaved}"><a href="#" onclick="checkData('${pageContext.request.contextPath}${analysisPageUrl}');" class="anch analysis cfsSuccessionReadinessAnalysisLink"><span class="txt">Analysis</span></a></li>
						<li class="fl list inactiveLink"><a href="#" class="anch suggeset cfsSuccessionReadinessSuggesstionLink"><span class="txt">Suggestion</span></a></li>
...
$(document).ready(function(){
	...
	if(pieces != ""){
		for(var i=0;i<pieces.length;i++){
			if(pieces[i]=="saveCfsSuccessionReadinessLink"){
