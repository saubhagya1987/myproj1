...
<!--                     </li> -->
            <li class="third"><label class="fl">As On Date</label>
            ...
            <li>
                      <input type="submit" value="Search" class="common_btn" onclick="getAdvisorWiseClientHolding(${sessionScope.userSession.partyId})">
                    </li>
          </ul> --%>
      ...
      <ul class="col-lg-3 col-lg-offset-9">
             <li class="btn-group">
				<input type="submit" value="Search" class="btn btn-pink" id="searchBtn" onclick="getAdvisorWiseClientHolding(${sessionScope.userSession.partyId})"/>
              </li>
                <li class="btn-group"> 
...
//var reportLink = "http://202.87.46.144/ReportServer/Pages/ReportViewer.aspx?%2fFIINFRA-Reports%2f";


url =reportLink+"AdvisorWiseUnitHoldingReport&rs:Command=Render&rc:Parameters=false&Partner_id="+Partner_id+"&AsOnDate="+AsOnDate+"&Party_id="+ClientpartyId+"&partnerId="+Partner_id+"&loggedpartyId="+Partner_id+"";
...
var objectName ='PartnerId::'+Partner_id+',AsOnDate::'+AsOnDate1+',ClientpartyId::'+ClientpartyId+',PartnerId::'+Partner_id;
$.ajax({
	 type :'POST',
...
$(document).ready(function(){
	  $.ajax({
			 type :'GET',
	      url :'${pageContext.request.contextPath}/report/urlForReport.htm',
			 success : function(result) 
			 {
