...
public class ReportRenderer  {
	...
	//@Value("${INPUT_REPORT_FOLDER}")
//	private String INPUT_REPORT_FOLDER="D:\\Apps\\ReportFolder";
	...
	protected void processReportDesignDocAndRenderReport(HttpServletRequest request,
		...
		String reportNameWithExtension = request.getParameter( this.reportNameRequestParameter );
		String reportName =reportNameWithExtension.replaceFirst("[.][^.]+$", "");
		...
		String downloadFileName = reportName+"."+format;
		...
		runnable = birtEngine.openReportDesign( FiinfraUtility.getProperyValue("REPORT_DIR")+reportNameWithExtension );
		...
		iRunTask.run(FiinfraUtility.getProperyValue("REPORT_DIR")+"temp.rptdocument");
		//iRunTask.run("D:\\Reportss\\WebContent\\Reports"+File.separator+"temp.rptdocument");
		iRunTask.close();
		
		
		//now do the rendering operation
		IReportDocument reportDoc = birtEngine.openReportDocument(FiinfraUtility.getProperyValue("REPORT_DIR")+"temp.rptdocument" );
		//IReportDocument reportDoc = birtEngine.openReportDocument("D:\\Reportss\\WebContent\\Reports"+File.separator+"temp.rptdocument" );
	...
	/*	System.err.println("SOP to be deleted -> Parameter Map" + parms);*/
