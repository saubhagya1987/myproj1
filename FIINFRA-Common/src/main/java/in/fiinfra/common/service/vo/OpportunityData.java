...
public class OpportunityData{
	...
	private String  fpplanType;
	
	public String getFpplanType() {
		return fpplanType;
	}
	public void setFpplanType(String fpplanType) {
	...
	private String workprofessionSpouse;
	private String workprofessionMother;
	private String workprofessionFather;
	private String workprofessionMotherInLow;
	private String workprofessionfatherInLaw;
	private String  workprofessionHuf;
	
	public String getWorkprofessionfatherInLaw() {
		return workprofessionfatherInLaw;
	}
	public void setWorkprofessionfatherInLaw(String workprofessionfatherInLaw) {
		this.workprofessionfatherInLaw = workprofessionfatherInLaw;
	}
	public String getWorkprofessionMotherInLow() {
		return workprofessionMotherInLow;
	}
	public void setWorkprofessionMotherInLow(String workprofessionMotherInLow) {
		this.workprofessionMotherInLow = workprofessionMotherInLow;
	}
	public String getWorkprofessionFather() {
		return workprofessionFather;
	}
	public void setWorkprofessionFather(String workprofessionFather) {
		this.workprofessionFather = workprofessionFather;
	}
	public String getWorkprofessionMother() {
		return workprofessionMother;
	}
	public void setWorkprofessionMother(String workprofessionMother) {
		this.workprofessionMother = workprofessionMother;
	}
	public String getWorkprofessionSpouse() {
		return workprofessionSpouse;
	}
	public void setWorkprofessionSpouse(String workprofessionSpouse) {
	...
	public String getWorkprofessionHuf() {
		return workprofessionHuf;
	}
	public void setWorkprofessionHuf(String workprofessionHuf) {
