   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Operations MIS</a>
...
<!-- Search start--> 
          	<form onsubmit="return false">
							...
							<tr>
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="popup('popUpAlertaddnote')">
								</a> </td>
							</tr>								
							 </table>       
							</div>
...
function getCurrentDate(){
   ...
   function resetVal()
  {
   ...
   $(document).ready(function(){
		  $('#SPPartnerOperationsMISReportLink').css('font-weight','bold');
		  $.ajax({
				 type :'GET',
