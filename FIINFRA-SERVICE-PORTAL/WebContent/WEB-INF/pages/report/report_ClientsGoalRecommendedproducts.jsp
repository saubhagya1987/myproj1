   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Clients Goal Wise Recommended Products </a>
...
<!-- Center part End -->          
	...
	function getClientGoalProReport(partyid){
	...
	var url="Rpt_SP_ClientGoalWiseRecProduct&rs:Command=Render&rc:Parameters=false&buId="+buId+"&partnerId="+partnerId+"&partyId="+partyId+"&loggedpartyId="+partyid+"";
	
	  callReport(url);
	 
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='Goal Reports';
	  var sourceScreen='Client Goal Wise Recommeded Products';
	  var objectName = 'BusinessUnit::'+buId+', partnerId::'+partnerId+', ClientPartyId::'+partyId+', loggedpartyId::'+loggedpartyId;
	  $.ajax({
			 type :'POST',
			  ...
			  function resetVal()
				 ...
				 function chkform()
		         {
		        	if (document.getElementById("quickSearchpart").value === "" ) 
		           {
		        	...
		        	{
		        		getClientGoalProReport(${sessionScope.userSession.partyId});
				 ...
				 $(document).ready(function(){
					  $('#SPClientsGoalRecommendedprodReportLink').css('font-weight','bold');
