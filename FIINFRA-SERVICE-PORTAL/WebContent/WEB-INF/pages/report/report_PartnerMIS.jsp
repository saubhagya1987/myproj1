   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner MIS </a>
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="radio" name=myradio value="1" checked="checked" onclick="getLastDate()"/><b>Since Inception</b>&nbsp&nbsp
									 ...
									 <input type="radio" name=myradio value="3" onclick="getselectStartDate()"/><b>Select Date</b>
								</div>
							</div>     
						</div>
						<div class="space-2"></div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPartnerMIS(${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div>
...
<!-- Center part End -->   
  ...
  <script>
  function getPartnerMIS(partyid){
	...
	var url="Rpt_SP_PartnerMIS&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";
 ...
 function getLastDate(){
   ...
   document.getElementById("to").disabled=true;
	 ...
	 return last_Date_Str;
	  ...
	  $(document).ready(function(){
		  $('#SPPartnerMISReportLink').css('font-weight','bold');
