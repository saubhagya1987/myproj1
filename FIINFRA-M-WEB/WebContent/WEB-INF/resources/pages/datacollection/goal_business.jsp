			      ...
			      <x:when select="$item/@QuestionType = '85009'">
							...
							<c:choose> <c:when test='${count.index == 6 }'>Number1</c:when><c:when test='${count.index != 6 }'>Number1</c:when></c:choose>" />
			    				...
			    				if(sliderVar == '#slider_9') {
			    					createSliderNew(sliderVar, <x:out select="$item/Scale/Min_Value" />, <x:out select="$item/Scale/Max_Value" />, <x:out select="$item/Scale/Increment" />,sliderValueVar,"15");
			    				}
			    				else {
	...
	<div class="row">
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/futureFinancialDc/travel-vacation-goal/${partyId}')">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-3 col-xs-4">
				...
				<c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/business-goal/${partyId}"/>
			...
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveAddBusinessGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/partner/datacollection/${partyId}/<%=request.getSession().getAttribute("headerName")%>/2')">
		...
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/futureFinancialDc/special-goal/${partyId}')">
