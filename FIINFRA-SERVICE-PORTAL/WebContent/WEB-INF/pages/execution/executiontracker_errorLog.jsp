    	...
    	<div class="container-head">
    	  <div class="row" style="text-align: right;"><!-- accordion start-->
                ...
                <div class="accordion-group">
                 ...
                 <span style="float:left;"> <input class="btn btn-sm btn-primary" type="button" value="Back" name="Back" onClick="window.history.back();" style="position: relative;bottom:6.5px;left: 980px"> </span>
...
<!-- <a href="#.html"><input data-params="{}" type="button" class="dbtn createNewBtn" value="  Add Transaction" title="Add Transaction" alt="Add Transaction"></a> -->
        ...
        <div class="table-responsive" id="display_table_lead" style="border:none;">
		  ...
		  <display:table name="uploadErrorLog" uid="objPortalUser" class="table table-hover table-bordered table-striped"
	requestURI="#" sort="list" pagesize="10" id="data">
	  
<%-- 		<display:column  class="" 
			style=""  title="Record No" property="recordNo" sortable="true" >
		</display:column> 
 --%>	 	
		<display:column  class="" 
			style=""  title="Failure Type" property="failureDataType" sortable="true" >
		</display:column> 
		
		<display:column  class="" 
			style=""  title="Error Details" property="errorDetails" sortable="true" >
		</display:column> 
