        ...
        <div class="analysis_parent">
          ...
          <div class="second_column">
           ...
           <div class="analysis_one_car_goal_img"> </div></div> 
            ...
            <div class="analysis_middle_car_goal"><div class="car_ana_title"> in <span class="car_ana_title_active">${endYear}</span> You will need an amount of<span class="car_ana_title_active"> ${endAmount} <span style="text-transform: lowercase;">lacs</span></span> for achieving your goal</div></div>
         ...
         <p class="txt">Whatever you are doing now will help you accumulate <span class="txt_act">${allocatedAssets} %</span> of the total amount you will need.</p>
         <p class="txt">You may fall short of the amount you need for retirement by <span class="txt_act">${amountNeeded } lacs</span>.</p>          </div>
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="${pageContext.request.contextPath}/partner/datacollection/retirement-planning/${partyId}" class="anch cancel"><span class="txt">Cancel</span></a></li>
