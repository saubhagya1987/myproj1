...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
 ...
 <!-- center -->
         ...
         <div class="list-group">
        		<a class="list-group-item active" href="#">Service Team task MIS</a>
...
<!-- Search start-->
          			...
          			<form onsubmit="return false">
							...
							<tr class="spacer"><td></td></tr>
							<tr>
								<td><a href="#" style="color: #fff;" onClick="reportnote();getPartOpenQueryList(${sessionScope.userSession.buId},${sessionScope.userSession.partyId})">
...
<!--<script src="<%=request.getContextPath()%>/js/jquery-1.9.1.js"></script> 
    ...
    $(document).ready(function(){
    	 $('#SPServiceTeamtaskMISReportLink').css('font-weight','bold');
    	addQueryTypeId();
    }); 
