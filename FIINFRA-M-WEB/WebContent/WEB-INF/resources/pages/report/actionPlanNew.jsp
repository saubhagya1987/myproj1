...
.header { height:65px; background:<%=colorCode %> url(${pageContext.request.contextPath}/resources/images/<%=imagePath %>) no-repeat center right; background-size:100%;}
...
.page1 #financial_planning_summary_content .client_details .category_ul .first .category{ background:url(${pageContext.request.contextPath}/resources/images/my_dream_goal_icon.png) no-repeat center center #fff}
.page1 #financial_planning_summary_content .client_details .category_ul .second .category{ background:url(${pageContext.request.contextPath}/resources/images/emergency.png) no-repeat center center #fff}
.page1 #financial_planning_summary_content .client_details .category_ul .third .category{ background: url(${pageContext.request.contextPath}/resources/images/risk.png) no-repeat center center #fff}
.page1 #financial_planning_summary_content .client_details .category_ul .fourth .category{ background: url(${pageContext.request.contextPath}/resources/images/succession.png) no-repeat center center #fff}
.page1 #financial_planning_summary_content .client_details .category_ul .five .category{ background: url(${pageContext.request.contextPath}/resources/images/retirement.png) no-repeat center center #fff}
...
.page1 #financial_planning_summary_content .disclaimer .btm_logo{ background:url(${pageContext.request.contextPath}/resources/images/btm_logo.png) no-repeat center center;width:194px;height:35px}

/* .page1 #financial_planning_summary_content .disclaimer .btm_logo1{ background:url(${pageContext.request.contextPath}/resources/images/fiinfra-logo.png) no-repeat center center;width:140px;height:35px} */
...
.page2 .ifa_head_logo { width:45px; height:47px; /* background:url(${pageContext.request.contextPath}/resources/images/ifa_head_logo.png) no-repeat center center; */ float:left; margin-left: 15px; }
/***Financial Planning Summary Ends***/
...
.page2 .goals_icon{ width:56px; height:45px; background:url(${pageContext.request.contextPath}/resources/images/my_dream_goal_icon.png) no-repeat center center; margin: 13px 8px;}
...
/*blue box*/
.page2 .box .blue { background-color:<%=colorCode %>; border-radius: 15px; padding:5px 12px; font-size: 14px; text-align:center; font-family: "Aller Bold"; color:#000; position:absolute; right: 10px; top: -13px; }
.page2 .box .blue .lumpsum { float:left; }
.page2 .box .blue .lumpsum .rupee { color:#FFF; margin-left:5px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe_w.png); width:7px; height:11px; display: inline-block; }
...
.page2 .box .blue .sip .rupee { color:#FFF; margin-left:5px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe_w.png); width:7px; height:11px; display: inline-block; }
...
.page2 .box .grey_box_cnt .grey_box:after { width:140px; background: url(${pageContext.request.contextPath}/resources/images/bx_shadow.png) no-repeat center center; content: ""; position: absolute; display: block; height: 15px; bottom: -7px; z-index: -1; }
...
/*icons*/
.page2 .box .grey_box .top .logo .house { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/house.png) no-repeat center center; }
.page2 .box .grey_box .top .logo .car { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/car.png) no-repeat center center; }
.page2 .box .grey_box .top .logo .education { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/education.png) no-repeat center center; }
.page2 .box .grey_box .top .logo .vacation { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/vacation.png) no-repeat center center; }
.page2 .box .grey_box .top .logo .wedding { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/wedding.png) no-repeat center center; }
.page2 .grey_box .top .logo .business { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/icns-business.png) no-repeat center center; }
.page2 .grey_box .top .logo .special { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/special-goal.png) no-repeat center center;background-size: 70%;}
.page2 .grey_box .top .logo .other{ width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/other_goals.png) no-repeat center center; background-size: 70%;}
.page2 .grey_box .top .logo .retirement{ width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/retirement_plan.png) no-repeat center center; }
...
.page2 .box .grey_box .middle .left .img { width:47px; height:40px; background-image: url(${pageContext.request.contextPath}/resources/images/lumpsum_amount.png); margin: 7px auto 5px auto; }
/*amount*/
.page2 .box .grey_box .middle .left .lumpsum { float:left; margin-top:5px; }
.page2 .box .grey_box .middle .left .lumpsum .rupee { color:#FFF; margin:0 1px 0 2px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe.png); width:7px; height:11px; float: left; }
...
.page2 .box .grey_box .middle .right .img { width:24px; height:35px; background: url(${pageContext.request.contextPath}/resources/images/sip_amount.png) no-repeat; margin: 8px auto 10px auto; }
/*amount*/
.page2 .box .grey_box .middle .right .sip { float:left; margin-top: 5px; }
.page2 .box .grey_box .middle .right .sip .rupee { color:#FFF; margin:0 2px 0 5px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe.png); width:7px; height:11px; float: left; }
...
.page2 .box .grey_box .bottom .left .rupee { color:#FFF; margin:0 3px 0 2px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe.png); width:7px; height:11px; float: left; }
...
.page3 .common_custom_checkbox { background: url(${pageContext.request.contextPath}/resources/images/blank_checkbox.png) no-repeat center center; height:20px; width:20px; display:block; }
.page3 .white_checkbox_checked { background: url(${pageContext.request.contextPath}/resources/images/checkbox.png) no-repeat center center; display: block; height: 20px; width: 20px; }
...
.page3 .goals_icon { width:56px; height:45px; background:url(${pageContext.request.contextPath}/resources/images/my_dream_goal_icon.png) no-repeat center center; margin: 18px 13px; }
.page3 .ifa_head_logo { width:45px; height:47px; /* background:url(${pageContext.request.contextPath}/resources/images/ifa_head_logo.png) no-repeat center center; */ float:left; margin-left: 15px; }
...
/*icons*/
.page3 .box .green .logo .house { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/house.png) no-repeat center center; }
.page3 .box .green .logo .car { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/car.png) no-repeat center center; }
.page3 .box .green .logo .education { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/education.png) no-repeat center center; }
.page3 .box .green .logo .vacation { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/vacation.png) no-repeat center center; }
.page3 .box .green .logo .wedding { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/wedding.png) no-repeat center center; }
.page3 .box .green .logo .business { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/icns-business.png) no-repeat center center; }
.page3 .box .green .logo .special { width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/special-goal.png) no-repeat center center; background-size: 70%; }
.page3 .box .green .logo .other{ width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/other_goals.png) no-repeat center center; background-size: 70%; }
.page3 .box .green .logo .retirement{ width: 40px; height: 40px; background: url(${pageContext.request.contextPath}/resources/images/retirement_plan.png) no-repeat center center; }
...
.page3 .box .grey_box_cnt:after { margin:27px 10px 26px 10px; width:100%; background: url(${pageContext.request.contextPath}/resources/images/shadow_big.png) no-repeat center center; content: ""; position: absolute; display: block; height: 15px; bottom: -18px; z-index: -1; }
.page3 .box .grey_box_cnt .grey_box { width:140px; background-color:#dedede; position:relative; z-index:9; float:left; }
.page3 .box .grey_box_cnt .grey_box:after { width:140px; background: url(${pageContext.request.contextPath}/resources/images/bx_shadow.png) no-repeat center center; content: ""; position: absolute; display: block; height: 15px; bottom: -7px; z-index: -1; }
...
.page3 .ria_bx .right .rupee { color: #FFF; margin: 5px 3px 0 4px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe_w.png); width: 7px; height: 11px; float: left; }
...
/*Rupee Box*/
.page3 .GWS_txt ul li.input_txt_four .rupee { color: #FFF; margin: 5px 3px 0 4px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe.png); width: 7px; height: 11px; float: left; }
...
.page3 .GWS_txt ul li.input_txt_seven .rupee { color: #FFF; margin: 5px 3px 0 4px; background-image: url(${pageContext.request.contextPath}/resources/images/ruppe.png); width: 7px; height: 11px; float: left; }
...
.page4 #er_planning .emergency_plan .shadow_small{background: url(${pageContext.request.contextPath}/resources/images/shadow_small.png) no-repeat;width: 100%;margin: 0px 0px 0px 0px;position: relative;left: 38px;top: 350px;z-index: -5;opacity: 0.7;}
.page4 #er_planning .emergency_plan .shadow_small2{background: url(${pageContext.request.contextPath}/resources/images/shadow_small.png) no-repeat;width: 50%;margin: 0px 0px 0px 0px;position: relative;left: 455px;top: 334px;z-index: -5;opacity: 0.7;}
...
.page4 #er_planning .emergency_plan .onetime .amount .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:0px 0px 0px 0px;}
...
.page4 #er_planning .emergency_plan .onetime .product1 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .onetime .product2 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .onetime .product3 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .onetime .app_amt .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px; margin-top:10px;}
...
.page4 #er_planning .emergency_plan .sip .amount .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:0px 0px 0px 0px;}
...
.page4 #er_planning .emergency_plan .sip .product1 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .sip .product2 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .sip .product3 .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px;}
...
.page4 #er_planning .emergency_plan .sip .app_amt .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin-left:10px; display: inline-block; margin:-3px 0px 0px 0px; background-size: 8px 12px; margin-top:10px;}
...
.wrapper .page4 .header .icon { height:72px; width:72px; -moz-border-radius:76px; -webkit-border-radius: 76px; border-radius:76px; border: 2px solid <%=colorCodeLeft %>; position: relative; top: 0px;left: 708px; background: #FFF url(${pageContext.request.contextPath}/resources/images/emergency.png) no-repeat center center; }
...
.page5 #er_planning .risk_planning .shadow_big1{background: url(${pageContext.request.contextPath}/resources/images/shadow_big.png) no-repeat;width: 100%;margin: 0px 0px 0px 0px;position: relative;left: -10px;top: -10px;z-index: -5;opacity: 0.7;background-size: 800px 21px;}
.page5 #er_planning .risk_planning .shadow_big2{background: url(${pageContext.request.contextPath}/resources/images/shadow_big.png) no-repeat;width: 100%;margin: 0px 0px 0px 0px;position: relative;left: -10px;top:-10px;z-index: -5;opacity: 0.7;background-size: 800px 21px;}
.page5 #er_planning .risk_planning .shadow_big3{background: url(${pageContext.request.contextPath}/resources/images/shadow_big.png) no-repeat;width: 100%;margin: 0px 0px 0px 0px;position: relative;left: -10px;top: -10px;z-index: -5;opacity: 0.7;background-size: 800px 21px;}
...
.page5 .early_death_header .icon_bg4{width:50px; height:50px; border:1px solid <%=colorCodeLeft %>; margin:-12px 10px 0px 0px; border-radius:50px; background-color: #FFF; background-image:url(${pageContext.request.contextPath}/resources/images/Personal-Accident.png);background-size: 19px 40px;background-repeat: no-repeat;background-position: center;}
...
.page5 .existing_header .existing .rupee{background: url(${pageContext.request.contextPath}/resources/images/rupee_thumb_w.png) no-repeat center center; background-size:40%;height: 20px;width: 20px;margin-left: 10px;display: inline-block;margin: 3px 0px 0px 0px;}
...
.page5 .existing_header .required .rupee{background: url(${pageContext.request.contextPath}/resources/images/rupee_thumb_w.png) no-repeat center center;background-size: 40%;
...
.page5 .suggestion .rupee{background: url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center;height: 20px;width: 20px;margin-left: 0px;display: inline-block;background-size: 8px 13px;}
...
.page5 #er_planning  .risk_planning .r_p .sug_product .prod1 .grn_patch .half_part .rupee{background: url(${pageContext.request.contextPath}/resources/images/rupee_thumb_w.png) no-repeat center center;height: 20px;width: 20px;margin-left: 0px;display: inline-block;background-size: 8px 13px; margin:2px 0px 0px 0px;}
...
.page5 #er_planning  .risk_planning .r_p .sug_product .prod1 .app_amt .rupee{background:url(${pageContext.request.contextPath}/resources/images/rupee_thumb.png) no-repeat center center; height:20px; width:20px; margin:20px 0px 0px -90px; background-size: 8px 12px;}
...
.wrapper .page5 .header .icon { height:72px; width:72px; -moz-border-radius:76px; -webkit-border-radius: 76px; border-radius:76px; border: 2px solid <%=colorCodeLeft %>; position: relative; top: 0px;left: 708px; background: #FFF url(${pageContext.request.contextPath}/resources/images/risk.png) no-repeat center center; }
...
.page6 #succession_planning .question .yes_no_answer .custom_radio.selected { background:url(${pageContext.request.contextPath}/resources/images/custom_selected.png) no-repeat center center }
.page6 #succession_planning .container_ul li { margin:0 0 0 120px;}

.wrapper .page6 .header .icon { height:72px; width:72px; -moz-border-radius:76px; -webkit-border-radius: 76px; border-radius:76px; border: 2px solid <%=colorCodeLeft %>; position: relative; top: 0px;left: 708px; background: #FFF url(${pageContext.request.contextPath}/resources/images/succession_gray.png) no-repeat center center; }
...
<body>
            ...
            <div class="content" id="financial_planning_summary_content">
              <div class="box1 ifa_details clearfix">
                ...
                <%-- <img src="${pageContext.request.contextPath}/resources/images/ifa_logo.png"/>  --%>
				    ...
				    <% } else { %>
				   		<img src="${pageContext.request.contextPath}/resources/images/temp_logo.png" alt="Advisor Logo" style="max-width: 150px;max-height: 60px;"/></a>
				    <% } %>
                </div>
              </div>
        ...
        <c:if test="${not(empty(emergencyPlanningDataList))}">
         <div class="page4 fl">
          ...
          <div class="onetime fl">
            ...
            <br><br><br><br>
            <c:forEach var="emergencyProductListFlag" items="${emergencyPlanningDataList}">
            	<c:if test="${emergencyProductListFlag.productId != 0 }">
            		<c:set var="emergencyFlag" value="1" />
            	</c:if>
            </c:forEach>
            
            <div class="onetime_line"></div>
            <c:if test="${emergencyFlag eq 1 }">
  ...
  <c:choose>
  	<c:when test="${reportFor eq 'client'}">
  		<div class="footer clearfix" style="page-break-after:always; margin-top:80px;">
    <!--div class="fl footer_tagline">True Friends of New Investors</div-->
    <div class="fr page_no">(<span class="no">${pageNumber}</span>)</div>
    <c:set var="pageNumber" value="${pageNumber+1 }" />
  </div>
  	...
  	<c:otherwise>
  		<div class="footer clearfix" style="page-break-after:always; margin-top:253px;">
    <!--div class="fl footer_tagline">True Friends of New Investors</div-->
    <div class="fr page_no">(<span class="no">${pageNumber}</span>)</div>
    <c:set var="pageNumber" value="${pageNumber+1 }" />
  </div>
