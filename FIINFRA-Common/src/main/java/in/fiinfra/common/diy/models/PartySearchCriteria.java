...
public class PartySearchCriteria implements Serializable {
	...
	public String getAutoPlanStatus() {
		return autoPlanStatus;
	}

	public void setAutoPlanStatus(String autoPlanStatus) {
		this.autoPlanStatus = autoPlanStatus;
	}
	...
	public Integer getDcActivation() {
		return dcActivation;
	}

	public void setDcActivation(Integer dcActivation) {
		this.dcActivation = dcActivation;
	}

	@JsonProperty
	private Integer dcActivation;
