...
public class QuestionMapper extends DbMapper<QuestionData> {

	@Override
	protected List<QuestionData> doMap(ResultSet rs) throws SQLException {
	...
	protected void mapOption(ResultSet rs, QuestionData q, OptionData op)
			throws SQLException {
		...
		/*
		 * op.setSelected(rs.getInt("selected") > 0); if (op.isSelected()) {
		 * q.setAnswered(true); }
		 */
	...
	protected void mapQuestion(ResultSet rs, QuestionData bean)
			throws SQLException {
