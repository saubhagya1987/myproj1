...
public class PartySetting 
{
	...
	@JsonProperty
	private Integer partySettingTypeId;
	...
	public Integer getPartySettingTypeId() {
		return partySettingTypeId;
	}

	public void setPartySettingTypeId(Integer partySettingTypeId) {
		this.partySettingTypeId = partySettingTypeId;
	}
