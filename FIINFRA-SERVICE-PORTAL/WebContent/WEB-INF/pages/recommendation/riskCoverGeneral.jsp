    ...
    <section class="content common_content">
			                        ...
			                        <div class="col-sm-12 col-xs-12">
			                          ...
			                          <div class="range_parent">                          
			                            ...
			                            <div class="col-sm-7 col-xs-6">
			                              ...
			                              <div id="slider_${productTypeCountTemp}_${productCount}" class="help-block"></div>
			                            </div>
      ...
      <div class="row">
        <div class="col-sm-1 col-xs-3">
          <a href="${pageContext.request.contextPath}/partner/recommendation/emergencyPlanning.htm"><button class="btn btn-app btn-transparent btn-xs"> <i class="ace-icon fa icon-back bigger-240 red"></i> Back </button></a>
        </div>
        ...
        <div class="col-sm-1 col-xs-3">
          <a href="${pageContext.request.contextPath}/partner/goalPlanning.htm" ><button class="btn btn-app btn-transparent btn-xs"> <i class="ace-icon fa icon-next bigger-240 red"></i> Next </button></a>
        </div>
      </div>
    </section>      
      <!-- Common footer ends -->
