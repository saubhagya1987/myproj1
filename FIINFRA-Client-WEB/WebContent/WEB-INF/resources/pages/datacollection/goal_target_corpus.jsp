    ...
    <jsp:include page="../layout/dc_submenu.jsp"></jsp:include> 
     ...
     <form class="form-horizontal" id="targetCorpusGoalForm" name="targetCorpusGoalForm" action="<c:url value="/futureFinancialDc/saveTargetCorpusGoal" />" method="POST">
      ...
      <section id="education_goal" class="in_content common_in_content clearfix education_goal" >
        ...
        <div style="margin: -28px 0px 0 222px; clear: both;float: left;width: 100px;height: 50px;"><span class="common_custom_checkbox"></span>
        <input type="checkbox" class="default_checkbox" name="isAllocateAssetChk" id="isAllocateAssetChk"/>        
        </div>
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="#" class="anch save"><span class="txt">Save</span></a></li>
  			<li class="fl list"><a href="javascript:void()" class="anch cancel" onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Cancel</span></a></li>
           
          </ul>
          
        </div>
        <a href="javascript:void(0);" class="back navgation" onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/futureFinancialDc/business-goal')"><span class="txt">Back</span></a> 
        <a href="javascript:void(0);" class="next navgation" onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/futureFinancialDc/other-goal')"><span class="txt">Next</span></a> 
        </section>
...
$(document).ready(function(){
	...
	$("#goalName").val("Target Corpus Goal");
	$("#hiddenGoalName").val("Target Corpus Goal");
