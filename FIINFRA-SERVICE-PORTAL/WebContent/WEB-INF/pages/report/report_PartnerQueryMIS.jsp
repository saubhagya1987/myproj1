   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Query MIS </a>
          	...
          	<form onsubmit="return false"> 
							...
							<tr>
								<td><a href="#" style="color: #fff;" onClick="reportnote();getPartOpenQueryList('PartnerOpenQueryList.rptdesign',${sessionScope.userSession.partyId})">
									<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show"  onClick="popup('popUpAlertaddnote')">
								</a> </td>
							</tr>								
						 </table>
						</div>
...
<script src="<%=request.getContextPath()%>/js/jquery-1.9.1.js"></script> 
    ...
    $(document).ready(function(){
    	 $('#SPPartnerQueryMISReportLink').css('font-weight','bold');
    	addQueryTypeId();
    }); 
