	...
	$('#menu-wplook-sub-menu5').addClass('active');	
	   ...
	   function getCapitalGainDetailed(partyid){
			...
			EndDate = mn+"-"+day+"-"+yr;
			  ...
			  url ="Rpt_SP_CapitalGainDetailedReport&rs:Command=Render&rc:Parameters=false&partner_id="+PartnerId+"&nodeId="+nodeId+"&PartyID="+ClientpartyId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+partyid+"&partnerId="+PartnerId+"";
		  alert("URL="+url);                                                            
		  callReport(url);
	 ...
	 function split( val ) {
		...
		function extractLast( term ) {
		    ...
		    $(document).ready(function(){
		    	 $('#SPCapitalGainDetailedReportLink').css('font-weight','bold');
