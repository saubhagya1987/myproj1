...
public class GenerateClientActionPlan {
	...
	private static final Logger logger = Logger
			.getLogger(GenerateClientActionPlan.class);
	
	 public static void generateAp(String isBiased){
		 
		 		 Document document = new Document();
			        document.setPageSize(PageSize.A4);
			 
			        String apReportPath="D:\\FFreedom-DI\\Attachments\\ActionPlan\\pdf\\"+String.valueOf(partyId);
			        ...
			        try {
						...
						PdfWriter writer=PdfWriter.getInstance(document, new FileOutputStream(apReportPath+"\\"+String.valueOf(partyId)+"_Client"+isBiased+".pdf"));
				    ...
				    try{
			        document= GenerateClientActionPlan.generateIndivisualAP(document,apDetailsList);
				    }
				    catch (Exception e) {
						// TODO: handle exception
				    	logger.error(e);
				    ...
				    try{
			        document= GenerateClientActionPlan.addDoc(document, partyId,apDetailsList);
				    }
				    catch (Exception e) {
						// TODO: handle exception
				    	logger.error(e);
	...
	public static void setAllDataList(List<Object> allDataList) {
		GenerateClientActionPlan.allDataList = allDataList;
	}
	...
	public static void AddFooter(Document doc)
	 {
	  ...
	  public static Document generateIndivisualAP(Document doc,List<APDetails> apDetailsList){
		 try{
			 doc.add(GenerateClientActionPlan.addimageinTable());
			  doc.add(GenerateClientActionPlan.createTitle(apDetailsList));
...
//		 try {
//			doc.add(GenerateClientActionPlan.createTable(apDetailsList));
//		} catch (DocumentException e) {
//			// TODO Auto-generated catch block
//		}
//		AddFooter(doc);
	  ...
	  public static Paragraph createTitle(List<APDetails> apDetailsList){
		  ...
		  Font font =  FontFactory.getFont("Arial", 8, Font.BOLD , BaseColor.BLACK);
			  ...
			  Chunk c;
			    ...
			    addEmptyLine(preface, 1);			  
			     ...
			     }catch(Exception e)
			     {
			       ...
			       p.add(new Chunk(partyName,FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.RED)));
			       preface.add(p);
			    //font = new Font(FontFamily.TIMES_ROMAN, 12, Font.BOLD, BaseColor.BLACK);
			    font =  FontFactory.getFont("Arial", 12, Font.BOLD , BaseColor.BLACK);
			    p=new Paragraph();
			   ...
			   // p.add(new Chunk("Rs."+apDetails.getTotalRevenuePossible(),FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.RED)));
//			    try{
////			    p.add(new Chunk("Rs.",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.RED)));
//			    }catch (Exception e) {
//					// TODO: handle exception
//				}
			    preface.add(p);
...
//			    p.add(new Chunk("Rs."+apDetails.getTotalAUA10years(),FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.RED)));
//			    preface.add(p);
			    addEmptyLine(preface, 3);			  
			    font =FontFactory.getFont("Arial", 12, Font.BOLD , (new BaseColor(r, g, b)));
	  ...
	  public static PdfPTable createTable(List<APDetails> apDetailsList) throws DocumentException {
	        ...
	        table.setWidths(new float[]{0.4f, 2f, 2f,2f,2f});
...
//	    		table.addCell(cell);
	    ...
	    public static Document addDoc(Document doc,int partyId,List<APDetails> apDetailsList){
	    	...
	    	//Font font =FontFactory.getFont("Arial", 13, Font.BOLD , (new BaseColor(r, g, b)));
	    	Font font =FontFactory.getFont("Arial", 13, Font.BOLD , (new BaseColor(r, g, b)));
		    ...
		    try {
		    	...
		    	doc.add(new Paragraph("\n"));
				doc.add(GenerateClientActionPlan.createTableForGoal());				
			} catch (DocumentException e) {
				// TODO Auto-generated catch block
				logger.error(e);
			}
//		    
		    try {
		    	...
		    	doc.add(new Paragraph("\n"));
				doc.add(GenerateClientActionPlan.createTableForInvestments());
				doc.add(new Paragraph("\n\n"));
			} catch (Exception e) {
				// TODO Auto-generated catch block
				logger.error(e);
		    ...
		    try {
		    	...
		    	doc.add(new Paragraph("\n"));
				doc.add(GenerateClientActionPlan.createTableForRisk());
				doc.add(new Paragraph("\n\n"));
			} catch (Exception e) {
				// TODO Auto-generated catch block
				logger.error(e);
							   ...
							   // TODO: handle exception
					    		   ...
					    		   phrase=new Phrase("",font1);
							    	  phrase.add("\n\nA comprehensive householder�s policy will cover Household contents  " +
								    	  ...
								    	  p=new Phrase("\n\nDo remember:",FontFactory.getFont("Arial", 11,Font.BOLD,(new BaseColor(r, g, b))));
								    	  phrase=new Phrase("\n\nInsurance will only cover the unknown only -  " +
									    			...
									    			FontFactory.getFont("Arial", 10,Font.NORMAL,(new BaseColor(r, g, b)))
								    			  );
									    	  try{
									    	    doc.add(p);
									    		doc.add(phrase);
		...
		public static Document fillClientBackground(Document doc, Paragraph p){
				   ...
				   // unorderedList.setListSymbol("\u2022");
				    ...
				    font =FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.RED);
				    Phrase phrase;
...
//				    font =FontFactory.getFont("Arial", 12,BaseColor.BLACK);
//				    c=new Chunk(" Emergency Funds",font);//
//				    purpose.add(c);
...
//						doc.add(purpose);
	...
	public static Document fillOpportunityRiskCover(Document doc, Paragraph p) {
		...
		font = FontFactory.getFont("Arial", 12,
...
public static Document fillClientBackgroundOnTaxPlan(Document doc, Paragraph p){
   ...
   // unorderedList.setListSymbol("\u2022");
    ...
    font =FontFactory.getFont("Arial", 12, BaseColor.RED);
    Phrase phrase;
 ...
 /*   font =FontFactory.getFont("Arial", 12, Font.BOLD , BaseColor.BLACK);		    		    
    ...
    font =FontFactory.getFont("Arial", 12,BaseColor.BLACK);
    Font font1 =FontFactory.getFont("Arial", 12,BaseColor.RED);
...
private static Document emergencyScript(Document doc){
    ...
    Paragraph p2=new Paragraph("\nRevenue Possible: Rs.",FontFactory.getFont("Arial", 12,Font.BOLD,BaseColor.BLACK ));
...
private static Document investmentScript(Document doc){
	...
	Paragraph pa=new Paragraph("\nTranscript� Investments:",FontFactory.getFont("Arial", 12,Font.BOLD,BaseColor.BLACK));
	 Phrase p=new Phrase();
	 p.add(""+
...
private static Document loanScript(Document doc){
	Font font =FontFactory.getFont("Arial", 13, (new BaseColor(r, g, b)));
	//Paragraph pa=new Paragraph("\nTranscript for discussion on loans:",FontFactory.getFont("Arial", 12,Font.BOLD,BaseColor.BLACK));
	Paragraph pa=new Paragraph("Debt Management:",FontFactory.getFont("Arial", 12,Font.BOLD , (new BaseColor(r, g, b))));
	Font font1 =FontFactory.getFont("Arial", 10,BaseColor.BLACK );
...
private static Document taxScript(Document doc){
	Font font =FontFactory.getFont("Arial", 13, (new BaseColor(r, g, b)));
	Paragraph pa=new Paragraph("Tax Planning:",FontFactory.getFont("Arial", 12,Font.BOLD , (new BaseColor(r, g, b))));
	Font font1 =FontFactory.getFont("Arial", 10, BaseColor.BLACK);
	 Phrase p=new Phrase("",font1);
...
//	 Chunk c;
//	 Paragraph p2=new Paragraph("\nRevenue Possible: Rs.",FontFactory.getFont("Arial", 12,Font.BOLD,BaseColor.BLACK ));
//	 c=new Chunk(apDetails.getTaxRevenue(),FontFactory.getFont("Arial", 12,BaseColor.RED ));
//	  p2.add(c);
	  try{
		  doc.add(new Paragraph("\n\n"));
	    	doc.add(pa);
...
/*private static Document successionScript(Document doc){
	Font font =FontFactory.getFont("Arial", 12,BaseColor.BLACK);
	Paragraph pa=new Paragraph("\nTranscript for discussion on Succession:",FontFactory.getFont("Arial", 12,Font.BOLD,BaseColor.BLACK));
	 Phrase p=new Phrase();
...
//		
		...
		if(invAmount.equals("Rs.0")){
			invAmount="Seek Information from your IFA";
		}
...
//		cell=new PdfPCell(new Paragraph(products,font)); --- commented
		cell=new PdfPCell(p);
		table.addCell(cell);
...
private static Document successionScript(Document doc){
	Font font =FontFactory.getFont("Arial", 12,Font.BOLD, (new BaseColor(r, g, b)));
	Paragraph pa=new Paragraph("Succession Planning:",FontFactory.getFont("Arial", 14,Font.BOLD , (new BaseColor(r, g, b))));
