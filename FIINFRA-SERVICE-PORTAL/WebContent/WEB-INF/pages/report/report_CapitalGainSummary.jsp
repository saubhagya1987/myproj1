     ...
     <div class="row">
  		...
  		<div class="col-md-9">
					...
					<div class="list-group">
						<a class="list-group-item active" href="#">Capital Gain Summary</a>
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	$('#menu-wplook-sub-menu5').addClass('active');	
	   ...
	   $('#menu-wplook-sub-menu5 ul').css('display', 'block'); 	 
		  ...
		  function getCapitalGainSummary(partyid){
				...
				EndDate = mn+"-"+day+"-"+yr;
				  ...
				  url ="Rpt_SP_CapitalGainSummary&rs:Command=Render&rc:Parameters=false&partner_id="+PartnerId+"&nodeId="+nodeId+"&PartyID="+ClientpartyId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+partyid+"&partnerId="+PartnerId+"";
			  alert("URL="+url);                                                            
			  callReport(url);
	 ...
	 function split( val ) {
		...
		function extractLast( term ) {
		    ...
		    $(document).ready(function(){
		    	 $('#SPCapitalGainSummaryReportLink').css('font-weight','bold');
