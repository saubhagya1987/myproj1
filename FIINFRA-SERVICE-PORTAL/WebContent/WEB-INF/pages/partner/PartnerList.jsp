...
<!-- 					</div> -->
				<!-- 	<div id="poptable_contactform"
						...
						<table class="table table-hover table-bordered table-striped">
							...
							<tr>
								<td>White labeling & Customization</td>
							...
							<tr>
								<td>Onboarding of Relationships</td>
							...
							<tr>
								<td>Data Collection > Scenario > Financial Plan</td>
							...
							<tr>
								...
								<td><input type="text" name="regionId" id="regionId" class=" "  value=" " style="width: 200px;"  disabled></td>
							</tr>
							
							<tr>
								<td>Execution tracker</td>
								<td><input id="check6" type="checkbox"></td>
								<td><input type="text" name="execution_tracker" id="execution_tracker" class=" "  value=" " style="width: 200px;"  disabled></td>
							</tr>
							
							<tr>
								<td>Goal tracking & achievement</td>
								<td><input id="check7" value="check7" type="checkbox"></td>
									<td><input type="text" name="goal_tracking_achievement" id="goal_tracking_achievement" class=" "  value=" " style="width: 200px;"  disabled></td>
							</tr>
							
							<tr>
								<td>Track your practice</td>
								<td><input id="check8" value="check8" type="checkbox"></td>
									<td><input type="text" name="track_your_practice" id="track_your_practice" class=" "  value=" " style="width: 200px;"  disabled></td>
							</tr>
							
							<tr>
								<td>Self Financial Plan</td>
								<td><input id="check9" value="check9" type="checkbox"></td>
									<td><input type="text" name="self_Financial_Plan" id="self_Financial_Plan" class=" "  value=" " style="width: 200px;"  disabled></td>
							</tr>
					...
					<div class="modal-footer">
							...
							<input	type="hidden" id="FlagrollId" name="FlagrollId"	> 
...
<!-- 
							...
							<input class="dbtn" value="Cancel" id="Cancel" type="button" onclick="reload();">
								 -->
						 <button  id="save" class="btn btn-xs btn-primary" onClick="validate1();"  title="Save"><i class='ace-icon fa fa-plus'></i>Save</button>
				         <button class="btn btn-xs btn-primary"  onClick="reload()"><i class='ace-icon fa fa-trash'></i>Cancel</button> 
...
$('#check1').click(function() {
	...
	if(document.getElementById("check1").checked == true ){		
		 var rollId = $('#rollId').val(); if(rollId == 1 || rollId == 9){
		$("#proSponDate").prop("disabled", false); }	
	var d = new Date();
	$("#proSponDate").val( d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#proSponDate").prop("disabled", true); $("#proSponDate").val('');	}
	});

$('#check2').click(function() {
	if(document.getElementById("check2").checked == true ){	 var rollId = $('#rollId').val();if(rollId == 1 || rollId == 9){$("#welnConDate").prop("disabled", false);	}
	var d = new Date();
	$("#welnConDate").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );	
	}
	else{			$("#welnConDate").prop("disabled", true); $("#welnConDate").val('');	}
	});
	
$('#check3').click(function() {
	if(document.getElementById("check3").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#agreeSignDate").prop("disabled", false);	}
	var d = new Date();
	$("#agreeSignDate").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#agreeSignDate").prop("disabled", true);	$("#agreeSignDate").val('');}
	});
	
$('#check4').click(function() {
	if(document.getElementById("check4").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#onBoaredDate").prop("disabled", false);	}
	var d = new Date();
	$("#onBoaredDate").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#onBoaredDate").prop("disabled", true); $("#onBoaredDate").val('');	}
	});
	
	
	
$('#check5').click(function() {
	if(document.getElementById("check5").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#regionId").prop("disabled", false);}	
	var d = new Date();
	$("#regionId").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#regionId").prop("disabled", true); $("#regionId").val('');	}
	});
	
	
$('#check6').click(function() {
	if(document.getElementById("check6").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#execution_tracker").prop("disabled", false);}
	var d = new Date();
	$("#execution_tracker").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#execution_tracker").prop("disabled", true); $("#execution_tracker").val('');	}
	});
	
	
$('#check7').click(function() {
	if(document.getElementById("check7").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#goal_tracking_achievement").prop("disabled", false);}
	var d = new Date();
	$("#goal_tracking_achievement").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#goal_tracking_achievement").prop("disabled", true); $("#goal_tracking_achievement").val('');	}
	});
	
	
$('#check8').click(function() {
	if(document.getElementById("check8").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#track_your_practice").prop("disabled", false);}	
	var d = new Date();
	$("#track_your_practice").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#track_your_practice").prop("disabled", true); $("#track_your_practice").val('');	}
	});
	
	
$('#check9').click(function() {
	if(document.getElementById("check9").checked == true ){	 var rollId = $('#rollId').val();	if(rollId == 1 || rollId == 9){$("#self_Financial_Plan").prop("disabled", false);	}	
	var d = new Date();
	$("#self_Financial_Plan").val(d.getDate() + "/"+ (d.getMonth()+1)  + "/" + d.getFullYear() );
	}
	else{		$("#self_Financial_Plan").prop("disabled", true); $("#self_Financial_Plan").val('');	}
	});
    		 ...
    		 if(result == null || result == '' ){
    	    	 ...
    	    	 $(result).each(
		       	...
		       	case '91131' :  
    	    		...
    	    		case '91135' :    /* $('#regionId').val(); */
						     	    		   	
			     	    			$('#regionId').val(value.onboardListValue);  
										if(value.onboardListValue == null || $('#regionId').val() == '' || $('#regionId').val() == ' '){}else{ document.getElementById("check5").checked = true; $("#regionId").prop("disabled", false); } 
										break;
    	    								
    	    		case '91136' : 		
										$('#execution_tracker').val(value.onboardListValue);  
										if(value.onboardListValue == null || $('#execution_tracker').val() == '' || $('#execution_tracker').val() == ' '){}else{ document.getElementById("check6").checked = true; $("#execution_tracker").prop("disabled", false); } 
										break;
							
    	    		case '91137' : 		
										$('#goal_tracking_achievement').val(value.onboardListValue);  
										if(value.onboardListValue == null || $('#goal_tracking_achievement').val() == '' || $('#goal_tracking_achievement').val() == ' '){}else{ document.getElementById("check7").checked = true; $("#goal_tracking_achievement").prop("disabled", false); } 
										break;
							
    	    		case '91138' : 		
										$('#track_your_practice').val(value.onboardListValue);  
										if(value.onboardListValue == null || $('#track_your_practice').val() == '' || $('#track_your_practice').val() == ' '){}else{ document.getElementById("check8").checked = true; $("#track_your_practice").prop("disabled", false); } 
										break;
						
	    			case '91139' : 		
											$('#self_Financial_Plan').val(value.onboardListValue);  
											if(value.onboardListValue == null || $('#self_Financial_Plan').val() == '' || $('#self_Financial_Plan').val() == ' '){}else{ document.getElementById("check9").checked = true; $("#self_Financial_Plan").prop("disabled", false); } 
											break;		
...
/* function check()
{
	...
	if(validate1()==true)
		...
		submitAddChecklist();
			 ...
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
						"click" :
						{
...
function validate1(){
	...
	var flag =  $('#FlagrollId').val();
	 var rollId = $('#rollId').val();
	 
	if(document.getElementById("check1").checked == true){
		if($('#proSponDate').val() =='' || $('#proSponDate').val()==' ' ){			 
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#welnConDate').val() =='' || $('#welnConDate').val()==' ' ){			 
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#agreeSignDate').val() =='' || $('#agreeSignDate').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#onBoaredDate').val() =='' || $('#onBoaredDate').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
	...
	if(document.getElementById("check6").checked == true){
		if($('#execution_tracker').val() =='' || $('#execution_tracker').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#goal_tracking_achievement').val() =='' || $('#goal_tracking_achievement').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#track_your_practice').val() =='' || $('#track_your_practice').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
		...
		if($('#self_Financial_Plan').val() =='' || $('#self_Financial_Plan').val()==' ' ){			
			 bootbox.dialog({
					message: "<span class='bigger-110'>Please Enter Action Date for selected Stage.</span>",
					buttons: 			
					{
	 ...
	 if(rollId == 1 || rollId == 9 ){
		 
		}else if(rollId != 1 || rollId != 9 && flag ==1 ){}
		else{  return false;}
...
function submitAddChecklist(){
		...
		//alert("save");
		 ...
		 $.ajax({
			 type :'POST',
	         url : $('#contextPath').val() +"/partnersp/saveChecklist.htm?&hdnpartyId="+hdnpartyId+"&hdnuserId="+hdnuserId+"&PSdate="+PSdate+"&WCdate="+WCdate+"&ASdate="+ASdate+"&OBdate="+OBdate+"&region="+region+"&hdnbuId="+hdnbuId+"&execution_tracker="+execution_tracker+"&goal_tracking_achievement="+goal_tracking_achievement+"&track_your_practice="+track_your_practice+"&self_Financial_Plan="+self_Financial_Plan,
			 success : function(result)
			 {
					 bootbox.dialog({
	 						message: "<span class='bigger-110'>Checklist saved Successfully.</span>",
	 						buttons: 			
	 						{
	 							"click" :
	 							{
...
/*     $('#eARN').change(function(){
	 ...
	 $(document).ready(function() {
		...
		$('#goal_tracking_achievement').datepicker({
		        changeMonth : true,
		        changeYear : true,
		        minDate : '0',
		        yearRange : "1900:2200",
		...
		$('#track_your_practice').datepicker({
		        changeMonth : true,
		        changeYear : true,
		        minDate : '0',
		        yearRange : "1900:2200",
		...
		$('#self_Financial_Plan').datepicker({
	        changeMonth : true,
	        changeYear : true,
	        minDate : '0',
	        yearRange : "1900:2200",
...
//			jQuery(grid_selector).jqGrid('filterToolbar', { stringResult: true, searchOnEnter: true});
	...
	<script>
	 function partnerDashboard(firstName,lastName,partyID,recordTypeID,lastLogin,isActive){
		 ...
		 window.location.href= $('#contextPath').val()+'/dashboard/getPartnerdashboard.htm?partnername='+firstName+'&partyID='+partyID+'&recordTypeID='+recordTypeID+'&lastLogin='+lastLogin+'&active='+isActive;
	 }
