   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group"> 
        		<a class="list-group-item active" href="#">File Upload Distinct Error Summary </a>
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getFileUploadDistErrorSummary(${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	function getFileUploadDistErrorSummary(partyid)
	{
		  ...
		  url="Rpt_SP_FileUploadDistinctErrorSummary&rs:Command=Render&rc:Parameters=false&StartDate="+StartDate+"&EndDate="+EndDate+"&BuID="+buId+"&PartnerID="+PartnerId+"&BatchID="+batchId+"&loggedpartyId="+partyid+"";
		  ...
		  var sourceScreen='File Upload Distinct Error Summary';
			...
			function getLastDate(){
				 ...
				 return last_Date_Str;
						    ...
						    function isNumeric(n) {
						        ...
						        $(document).ready(function(){
						        	$('#SPFileUploadDistErrSummLink').css('font-weight','bold');
