			       ...
			       <x:when select="$item/@QuestionType = '85013'">		
					...
					<x:when select="$item/@QuestionType = '85002'">
						<li class="clearfix">
							...
							<input type="checkbox" name="car_type" value="checked" class="car_type orignal_checkbox"/>
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('frmCarGoal','${cancel}')"><span class="txt">Cancel</span></a></li>
...
/* $('.toggle').toggles({text:{on:'HI',off:'BYE'}}); */
    ...
    /* $( "#text__10" ).change(function() {
     ...
     // on load change html
      var text6 = parseFloat( $("#sliderValue_11").val()) +  parseFloat($("#sliderValue_12").val());
  				//$("#text__10").val(text6);
