   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">File Upload Error Summary </a>
				 	 ...
				 	 <form onsubmit="return false" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getfileUploadErrorSummary(${sessionScope.userSession.partyId});resetVal();"></a>
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	function getfileUploadErrorSummary(partyid)
	{
		  ...
		  url="Rpt_SP_FileUploadErrorSummery&rs:Command=Render&rc:Parameters=false&StartDate="+StartDate+"&EndDate="+EndDate+"&BuID="+buId+"&PartnerID="+PartnerId+"&BatchID="+batchId+"&loggedpartyId="+partyid+"";
		  ...
		  var sourceScreen='File Upload Error Summery';
			...
			function getLastDate(){
				 ...
				 return last_Date_Str;
						    ...
						    function isNumeric(n) {
						        ...
						        $(document).ready(function(){
						        	$('#SPFileUploadErrorSumLink').css('font-weight','bold');
