      	...
      	<section class="in_content common_in_content clearfix">
        	...
        	<x:choose>
				<x:when select="$item/@QuestionType = '85010'">
					<li id="confidence_scale" style="margin-top: -90px;margin-bottom: 100px;" class="clearfix rel" <c:out value="${isHidden}" /> >
				</x:when>
				<x:otherwise>
             				...
             				<div class="range_parent emer_confidence">
                				<div class="fl scale clearfix">
			                    	...
			                    	<x:if select="$item/IsCurrency = 1" >
			                  		...
			                  		var temp = '<x:out select="$item/@AttributeCodeId" />';
		                  			if(temp=='94511') {
		                  				createSliderAndSetValue("#div_" + temp, <x:out select="$item/Scale/Min_Value" />, <x:out select="$item/Scale/Max_Value" />, <x:out select="$item/Scale/Increment" />, "#" + temp,0);
		                  			}
		                  			else {
		                  			createSlider("#div_" + temp, <x:out select="$item/Scale/Min_Value" />, <x:out select="$item/Scale/Max_Value" />, <x:out select="$item/Scale/Increment" />, "#" + temp);
		                  			}
          					...
          					<ul>  
               				<x:forEach select="$item/Options/Option" var="optionElement">	                						                			
		                		<li>
			                        ...
			                        <div class="value-spinner" id="div_<x:out select="$optionElement/@AttributeCodeID" />">
									...
									<a href="${pageContext.request.contextPath}/assets/assetDetails/${partyId}/0?assetPage=2" id="a_<x:out select="$optionElement/@AttributeCodeID" />" style="display: none;text-align: center;width: 600px;font-size: 14px;font-weight: bold;margin-top: 10px;">Click For Detailed Retirement Fund</a>
			            	    </li>
		                  	</x:forEach>
		                  </ul>
		                 </div>
			...
			<section class="common_footer_actions">
				<div id="main_actions" class="clearfix">
					<ul class="reset clearfix fr btn_grup3">
						<li class="fl list"><a href="#" class="anch save saveCfsRetirementPlanningLink" ><span class="txt">Save</span></a></li>
					...
					<ul class="reset clearfix fr btn_grup2">
						<li class="fl list"><a href="#" onclick="uploadNote(${partyId},'/partner/datacollection/retirement-planning/${partyId}');" class="anch add_note"><span class="txt">Notes</span></a></li>						
						<li class="fl list"><a href="#" onclick="uploadDocument(${partyId},'/partner/datacollection/retirement-planning/${partyId}');" class="anch add_doc"><span class="txt">Documents</span></a></li>
					</ul>
					<c:set var="sectionId" value="39006"></c:set>
					<ul class="reset clearfix fl btn_grup1">
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/analysis/retirement/${partyId}/${sectionId}');" class="anch analysis cfsRetirementPlanningAnalysisLink"><span class="txt">Analysis</span></a></li>
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/suggestion/retirement-planning/${partyId}');" class="anch suggeset cfsRetirementPlanningSuggesstionLink"><span class="txt">Suggestion</span></a></li>
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/actionplan/goal/retirement-planning/${partyId}/null?goalTypeId=35015');" class="anch action_plan retirementReadinessActionPlan"><span class="txt">Action Plan</span></a></li>
					</ul>
				</div>
...
$(document).ready(function(){
	...
	var planType = '${userSession.planTypeId}';									
	
	if(planType == '522002') {										
		
		$('#div_94051').addClass("inactiveLink");
		$('#div_94055').addClass("inactiveLink");
		$('#a_94055').css("display","block");
		
		$('#div_94052').addClass("inactiveLink");
		$('#div_94056').addClass("inactiveLink");
		
		$('#div_94053').addClass("inactiveLink");
		$('#div_94057').addClass("inactiveLink");
		
		$('#div_94054').addClass("inactiveLink");
		$('#div_94058').addClass("inactiveLink");
