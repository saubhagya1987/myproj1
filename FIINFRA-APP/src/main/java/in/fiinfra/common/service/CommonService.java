...
public interface CommonService {
	...
	List<CodeValueData> getContatcDetails(int roleId,int loggedInUserPartyId,int buId);
	...
	String deleteQuery(String noteIds,int buId);
...
//	List<NotesData> getNoteList(int partyId, int buId);
	...
	public List<UserData> getUserForTagging(int partyId,String searchText ,int buId);

	PartyData getAllocatedTeamMembers(int partyId, int buId);
	List<CodeValueData> getCityList(int parentId, int buId);

	Integer updateQueryStatus(int queryId, int status, int buId,int lastUpdatedBy);
