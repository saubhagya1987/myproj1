   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Task List</a>
...
<!-- Center part End -->          
	...
	<script type="text/javascript">
	  ...
	  $(document).ready(function(){
		  $('#SPPartnerOpenTaskListReportLink').css('font-weight','bold');
	...
	function getPartOpenTaskList(buid,partyid)
	{
		...
		var url="Rpt_SP_PartnerOpenTaskList&rs:Command=Render&rc:Parameters=false&buID="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&taskType="+taskTypeId+"&taskOwnerPartyID="+PartnerId+"&taskContactPartyID="+taskconId+"&loggedpartyId="+partyid+"";
		callReport(url);
		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='CRM';
		  var sourceScreen='Partner Open Task List';
		  var objectName = 'BussinessUnitID::'+buId+', StartDate::'+StartDate1+', EndDate::'+EndDate1+', TaskContactID::'+taskconId+', PartnerPartyID::'+PartnerId+', TaskContactTypeID::'+taskTypeId+', LoggedInPartyID::'+partyid;
...
// 					        	partyId=ui.item.value;
    ...
    function addTaskTypeId()
    {
      ...
      ({
         ...
         url:$('#contextPath').val()+'/faq/getPicklistValues.htm?codeTypeIds=17',
          dataType: 'json',
    ...
    function addTaskContactTypeId()
    {
      ...
      ({
          ...
          type: "POST",
         // url: $('#contextPath').val()+'/birtReport/getCodeValueDescription.htm',
         url:$('#contextPath').val()+'/faq/getPicklistValues.htm?codeTypeIds=15',
          dataType: 'json',
          contentType: 'application/json',
             success:function(result)
          { 
	...
	function chkform()
	   {
	  	if (document.getElementById("quickSearchpart").value === "" ) 
	     {
	  	...
	  	else
	  		{
				...
				getPartOpenTaskList('${sessionScope.userSession.buId}','${sessionScope.userSession.partyId}');
