   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Login Exceptions Report</a>
	...
	$('#menu-wplook-sub-menu5').addClass('active');	
 	...
 	$('#menu-wplook-sub-menu5 ul').css('display', 'block');
  	...
  	function getLoginExcpReport(buid,partyid)
  	{
		 ...
		 url="Rpt_SP_LoginExceptionReport&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedinpartyId+"";	
		 callReport(url);
		  
		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='Security Reports';
		  var sourceScreen='Login Exception Report';
		  var objectName = 'BussinessUnitID::'+buId+', StartDate::'+StartDate1+', EndDate::'+EndDate1+', LoggedInPartyID::'+loggedinpartyId;
		  $.ajax({
				 type :'POST',
		 ...
		 return last_Date_Str;
 		 			  ...
 		 			  function resetVal()
 		 			 {
 		 			  ...
 		 			  $(document).ready(function(){
 		 				 $('#SPLoginExceptionsReportLink').css('font-weight','bold');
