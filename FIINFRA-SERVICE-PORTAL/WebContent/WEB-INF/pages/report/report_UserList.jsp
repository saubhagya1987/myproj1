   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">User List</a>
			 ...
			 <form onsubmit="return false" class="form-horizontal">
					...
					<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<select name="addroleId" id="addroleId" ></select>
								</div>
							</div>     
						</div>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getUserList(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div>
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	function getUserList(buId,partyid){
		
	var buId = buId;
	var StartDate1=$("#from").val();
	var EndDate1=$("#to").val();
	var UserType = $("#addroleId").val();
	...
	var url="Rpt_SP_UserListReport&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&roleid="+UserType+"&loggedpartyId="+partyid+"";
	callReport(url);
	var actionByUserID = ${sessionScope.userSession.userId};
	var sourceModule='Security Reports';
	var sourceScreen='User List Report';
	var objectName = 'BusinessUnit::'+buId+',StartDate::'+StartDate1+',EndDate::'+EndDate1+',RoleTypeId::'+roleid+', loggedpartyId:: '+partyid;
	$.ajax({
			 type :'POST',
	    ...
	    function  reportnote()
    {
	   			  ...
	   			  contentType: 'application/json',
	   	   		  ...
	   	   		  { 
	   				   			$(result).each(function(i, obj) {
	   				   				...
	   				   				$('#addroleId').empty();
	   								$('#addroleId').append('<option value="0">All</option>');						
	    ...
	    $(document).ready(function(){
	    	 $('#SPUserListReportLink').css('font-weight','bold');
	    	userRolelist();
	    });
