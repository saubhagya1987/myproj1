...
public interface FolioDao {
	...
	public void deleteFolioNominations(int buId, int createdBy,String commaSeperatedList);
	 ...
	 * @param buId
	 * @param partyId
	 * @return {@link Map} returns the data for different types of transaction Type ,Exchange , D-mat Account.
	 */
	...
	/**
	 * Method to save the MFPortfolio Add/Edit form data
	 * @param buId
	 * @param createdBy
	 * @param clientId
