...
#page_loader { background:url(${pageContext.request.contextPath}/resources/images/loader.gif) no-repeat center center; }
</style>
<style>
#confirmDialog {
display: block;
...
<div class="clr"></div>
      ...
      <div class="page_header">
        ...
        <a href="#" onclick="setDefaultValues();" class="set_default saveSuccessionPlanningLink"><span class="set_default_txt">Set Default </span></a>        
          <!-- <button class="header_btn" id="help">Help</button> --> 
          <span class="head_txt">Succession Planning</span><span class="heading_icon"><span class="head_icon"><img src="${pageContext.request.contextPath}/resources/images/succession_advice.png" alt="" vspace="9" class="rp-margin"/></span></span></h1>
      </div>
    </header>
    <!-- Header Ends--> 
    ...
    <section class="content common_content">
      ...
      <section class="in_content common_in_content clearfix my_profile_parent" id="vaccation_planning">
        ...
        <form method="post" name="vacationPlanningform" id="vacationPlanningform" action="<c:url value="/partner/saveSuccessionPlanings"/>
        ">
        ...
        <section id="vaccation" class="clearfix">
          <c:forEach items="${taxPlanningList}"  varStatus="loopCounter" var="vacation">
            <ul class="reset clearfix first_ul">
              <li class="first">
                <select id="productCategory_${loopCounter.count}" name="productCategory_${loopCounter.count}">
                </select>
              </li>
              <li class="second">
                <select id="companyName_${loopCounter.count}" name="companyName_${loopCounter.count}">
                </select>
              </li>
              <li class="third default_parent">
                <select id="productName_${loopCounter.count}" name="productName_${loopCounter.count}">
                </select>
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            <c:if test="${sessionScope.userSession.buId!='27829' || (sessionScope.userSession.buId=='27829' && sessionScope.userSession.roleId=='212')}">
            	<li class="fl list"><a href="#" class="anch save saveSuccessionPlanningLink" onclick="formSubmit();"><span class="txt">Save</span></a></li>
            </c:if>
