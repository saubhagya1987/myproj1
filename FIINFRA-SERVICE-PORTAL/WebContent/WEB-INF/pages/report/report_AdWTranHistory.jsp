...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	$('#menu-wplook-sub-menu5').addClass('active');	
	 ...
	 function getAdvisorWiseTransactionStatement(partyid){
		  ...
		  url ="Rpt_SP_AdvisorWiseTransactionStatement&rs:Command=Render&rc:Parameters=false&Partner_id="+PartnerId+"&start_date="+StartDate+"&end_date="+EndDate+"&Party_id="+ClientpartyId+"&nodeId="+nodeId+"&Product_id="+TxnTypeId+"&issuer_id="+IssuerId+"&partnerId="+PartnerId+"&loggedpartyId="+partyid+"";
		  //alert("URL="+url);                                                            
		  callReport(url);
		  ...
		  var objectName ='PartnerId'+PartnerId+',StartDate::'+StartDate1+',EndDate::'+EndDate1+',ClientpartyId::'+ClientpartyId+',TxnTypeId::'+TxnTypeId+',IssuerId::'+IssuerId+',PartnerId::'+PartnerId+',nodeId::'+nodeId+',LoginPartyID'+partyid;
		  $.ajax({
				 type :'POST',
		...
		/*  function addcodevalueDescription()
		    {
		      ...
		      ({
		         ...
		         url:$('#contextPath').val()+'/faq/getPicklistValues.htm?codeTypeIds=502',
		          dataType: 'json',
		    ...
		    function addInvestorStartDate()
		    {
		      ...
		      ({
		          ...
		          Type: "POST",
		          url:$('#contextPath').val()+'/birtreport/getInvestorStartDate.htm?productId='+$('#productId').val()+"&partyid="+$('#quickSearchHidden').val(),
		          dataType: 'json',
		          contentType: 'application/json',
		          success:function(result)
		          { 
		    ...
		    $(document).ready(function(){
		    	 $('#SPadvisorTransactionHistoryReportLink').css('font-weight','bold');
	   ...
	   function chkform()
	   {
	  	...
	  	else if (document.getElementById("quickSearch").value === "" ) 
	    {
	  	...
	  	else
	  	{
	  		...
	  		getAdvisorWiseTransactionStatement(partyid);
