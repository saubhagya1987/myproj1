...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
  ...
  <!-- center  part -->
   ...
   <!--div starts  -->      
     <div class="row">
			...
			<div class=" col-md-3 sidebar-offcanvas" role="navigation"
				...
				<div class="list-group">
					<a class="list-group-item active" href="#">Execution Reports</a> <a
						...
						id="executionTrackerListLink"><strong> Execution
							Tracker List </strong></a> <a href="loadreportExecTrackClientMIS.htm"
						class="list-group-item" href="#"
						id="executionTrackerClientMIsLink">Execution Tracker MIS</a>
			...
			<div class="col-md-9">
				...
				<div class="list-group">
					<a class="list-group-item active" href="#"> Execution Tracker
						List</a>
			...
			<form onsubmit="return false" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getExecTrackerList(${sessionScope.userSession.partyId},${sessionScope.userSession.buId},${sessionScope.nodeId});resetval();">
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>
   ...
   function getExecTrackerList(partyid,buid,nodeId)
   {
	   	  var buId = buid; 
		...
		/*  var reportLink= $('#abc').val(); */
		 url="ExecutionTrackerList&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedinpartyId+"&nodeId="+nodeId+"";
		 callReport(url);
		/*  var reportview2 = "<iframe src="+url+" width='1010' height='840'></iframe>"; 
		 $("#gen2").html(reportview2); */
		  ...
		  var sourceScreen='Execution Tracker List';
