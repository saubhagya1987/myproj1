   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">System Access List </a>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getLoginExcpReport(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a> 
								</div>
							</div> 
						</div> 
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	function getLoginExcpReport(buid,partyid)
	{
		{
		  ...
		  url="Rpt_SP_SystemAccessHistoryReport&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedinpartyId+"";
			callReport(url);

		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='Security Reports';
		  var sourceScreen='System Access History';
		  var objectName = 'BusinessUnitID::'+buId+', StartDate::'+StartDate1+', EndDate::'+EndDate1+', LoggedInPartyID::'+loggedinpartyId;
		  $.ajax({
				 type :'POST',
  ...
  function getCurrentDate(){
	...
	$(document).ready(function(){ 
		 $('#SPSystemAccessHistoryReportLink').css('font-weight','bold');
