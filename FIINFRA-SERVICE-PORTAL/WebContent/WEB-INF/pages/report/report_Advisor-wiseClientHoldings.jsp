...
<!-- Center part End -->           
	...
	$('#menu-wplook-sub-menu5').addClass('active');	
	 ...
	 function getAdvisorWiseClientHolding(partyid){
      ...
      url ="Rpt_SP_AdvisorWiseUnitHoldingReport&rs:Command=Render&rc:Parameters=false&Partner_id="+PartnerId+"&AsOnDate="+AsOnDate+"&Party_id="+ClientpartyId+"&partnerId="+PartnerId+"&loggedpartyId="+partyid+"";
      callReport(url);
	  ...
	  var objectName ='PartnerId::'+PartnerId+',AsOnDate::'+AsOnDate1+',ClientPartyId::'+ClientpartyId+',PartnerId::'+PartnerId+', loggedpartyId:: '+partyid;
	  $.ajax({
			 type :'POST',
   ...
   $('#quickSearch').keyup(function() {
         ...
         function chkform()
         {
        	if (document.getElementById("quickSearchpart").value === "" ) 
           {
        	...
        	{
        		getAdvisorWiseClientHolding(${sessionScope.userSession.partyId});
         ...
         $(document).ready(function(){
        	 $('#SPUnitHoldingsReportLink').css('font-weight','bold');
