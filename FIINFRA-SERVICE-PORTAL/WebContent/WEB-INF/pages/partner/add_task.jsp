...
<input type="hidden" id="hidecompletionDateTime1" name="hidecompletionDateTime1" value="${completionDateTime1}">
	...
	<!-- Center part start -->
	<section>
		<form id="addTaskForm" name="FileUploadForm"	action="<%=request.getContextPath()%>/partnersp/saveTask.htm"
...
<input type="hidden" id="hideattachment3ID" name="attachment3DocumentID" value="${attachment3ID}">
		
					
					
					     <div class="page-header clearfix">
                <h1 class="pull-left"><B>Add/Edit Task</B></h1>
...
<!-- 								<select name="statusId" id="taskStatus" class="input-xxlarge" onchange=" getdates()">
							...
							<div class="col-sm-9">
								<input type="text" class="input-xxlarge"
									...
									title="Completion Date" readonly="true">
								<!--  <div id="duedate_error" class="help-block  red hide">Please add Valid target</div> -->							
							</div>
							</div>
							</div>
							...
							<div class="col-sm-9">
								<input type="text" id="subject" name="subject" onkeypress ="change()"
	...
	<div class="topmenu">
	 	...
	 	<div style="float:right;">
                    			...
                    			<!-- <button  id="btn_update_c" class="btn btn-sm btn-danger" onclick="cancel()" ><i class='fa fa-times'></i>Cancel</button>  -->
									...
									<a href="<%=request.getContextPath()%>/partnersp/getTaskList.htm"><input class="btn btn-sm btn-danger" id="btn_update_c" type="button" value="Cancel" name="Cancel" ></a>				
...
<div class="topmenu">
	<input type="hidden" id="onself" value="1">
		...
		<div style="float:right;">					
								<button id="btn_save" class="btn btn-sm btn-primary"  onClick="saveTask(0);"><i class='ace-icon fa fa-plus'></i>Save & New</button>
								<button id="btn_save1"  class="btn btn-sm btn-primary"   onClick="saveTask(1);"><i class='ace-icon fa fa-plus'></i>Save & Close</button>
...
document.getElementById("duedate").value = date;
			...
			$
					.ajax({
						type : "POST",
						url : $('#contextPath').val()
								+ '/faq/getPicklistValues.htm?codeTypeIds=18,19,17',
						success : function(result) {
...
$('#enddate').datetimepicker({ format: 'DD/MM/YYYY hh:mm A'}).next().on(ace.click_event, function()
		{
