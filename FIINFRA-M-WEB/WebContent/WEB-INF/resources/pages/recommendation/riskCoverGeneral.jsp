...
.ep_three .selectboxit-container .selectboxit-text {
...
function setDefaultValues(){
	if("${recordTypeId}"==14003){
		if("${assetHeader}" == "Risk Cover"){
			if("${categoryId}" == "48026"){
				$(".aa_up").html("<spring:message code='riskCoverHealth.dataReset' />");
			}else if("${categoryId}" == "48027"){
				$(".aa_up").html("<spring:message code='riskCoverCritical.dataReset' />");
			}else if("${categoryId}" == "48025"){
				$(".aa_up").html("<spring:message code='riskCoverAccidental.dataReset' />");
			}else if("${categoryId}" == "48024"){
				$(".aa_up").html("<spring:message code='riskCoverProperty.dataReset' />");
			}
		}		
...
<div class="clr"></div>
      ...
      <div class="page_header">
        ...
        <a href="#" class="drop_menu"></a><a href="#" onclick="setDefaultValues();" class="set_default saveRiskCover${categoryId}"><span class="set_default_txt">Set Default </span> </a>
                    ...
                    <c:when test="${adviceRecommendation.ispreferredProduct eq 1}">
                      <c:if test="${preferredFlag eq 0}">
                        ...
                        <div class="AT_cnt_title">
                          <ul>
                            <li class="AR_two_two">Company</li>
                            <li class="AR_three_one">Product</li>
                            <li class="AR_four">Range</li>
                            <li class="AR_five">% Share</li>
                          </ul>
                        </div>
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            <c:if test="${sessionScope.userSession.buId!='27829' || (sessionScope.userSession.buId=='27829' && sessionScope.userSession.roleId=='212')}">
        	    <li class="fl list"><a href="#" onclick="submitData();" class="anch save saveRiskCover${categoryId}"><span class="txt">Save</span></a></li>
      	    </c:if>
	 ...
	 for(var i=1;i<=productCount;i++){
		 ...
		 for(var j=1;j<categoryCount;j++){
			...
			createSliderAndSetValue1(sliderVar, 0, 100, 1, allocationVar, $(equitySliderValue).val());
			 ...
			 if($(companyDropdownValueId).val()!="" && $(companyDropdownValueId).val()!="undefined"){
