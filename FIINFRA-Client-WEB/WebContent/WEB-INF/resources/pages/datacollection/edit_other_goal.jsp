      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
           ...
           <li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('otherGoalForm','${cancel}')"><span class="txt">Cancel</span></a></li>
