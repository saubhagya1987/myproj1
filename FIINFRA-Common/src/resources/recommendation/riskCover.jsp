...
<div class="col-md-5 col-xs-12">
    ...
    <section class="content common_content">
      ...
      <div class="row">
        ...
        <div class="col-sm-1 col-xs-3">
          <a href="${pageContext.request.contextPath}/partner/taxPlanning.htm" ><button class="btn btn-app btn-transparent btn-xs"> <i class="ace-icon fa icon-next bigger-240 red"></i> Next </button></a>
        </div>
      </div>
    </section>      
      <!-- Common footer ends -->
