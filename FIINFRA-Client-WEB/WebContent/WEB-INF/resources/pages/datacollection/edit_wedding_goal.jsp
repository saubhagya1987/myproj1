			            ...
			            <li class="clearfix">
			              ...
			              <div>
			                ...
			                <x:if select="$item/IsReadOnly = '0'">
			                	<input type="text" class="common_input2 answers required" id="text__${count.index}" value="${goalMap[attributeCodeId]}" name="text__${count.index}" />
			                </x:if>
			              </div>                 
			            </li>	
			        </x:when>	
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('frmWeddingGoal','${cancel}')"><span class="txt">Cancel</span></a></li>
...
$("#car_type").on('toggle', function (e, active) {
     ...
     */
	   ...
	   /*  $("#text__4").change(function(ele){ 
	    ...
	    // on load of doc
	      var text6 = parseFloat( $("#sliderValue_5").val()) +  parseFloat($("#sliderValue_6").val());
  				//$("#text__4").val(text6);
	   			$("#slider_5").slider("option", "max", parseFloat($("#text__4").val()));
	    	    $("#slider_6").slider("option", "max", parseFloat($("#text__4").val()));
	    	    $("#sliderMaxValue_5").html($("#text__4").val());
