...
<style>
.output-body .cash-flow-controls ul { margin: 10px -1px 5px 0 !important; }
h5 { font-size: 20px; }
.did-you-know { height: 155px; }
.container-head p { text-shadow: none; }
a { cursor: pointer; }
.radiolable { margin-right: 5px; }
.tdinp { width: 100%; }
.output_header { width: 898px; }
.output_header_subhead { color:white; }
table { margin-bottom: 10px; }
.action-buttons { margin-right: -10px !important; }
table tr td { /* padding-bottom: 10px; */
padding-top: 10px; }
#riskCoverQuestion table { height: 30px !important; }
#riskCoverQuestion .textfieldg { width: 100% }
.bold { font-weight: bold; }
.errorMessage1 { color: red; font-size: 0.9em; margin: 4px !important; font-size: 18px; }
.output_header { float:left; background:url(../../images/Axis-op/output_header_newFFE.png) no-repeat top right; height:92px; width:980px; margin:0px 0 0 0px; }
</style>
...
<style>
.border { border: 1px solid !important; border-color: red !important; }
.input-box-controls { /* 	background: none repeat scroll 0 0 #7F7F7F; */ border: medium none; display: inline-block; margin-left: 4px; padding: 9px 5px; width: 246px; color: black !important; }
.ui-slider-handle { width: 0px !important; }
.output-body .cash-flow-controls .drop-down-controls select { color: white; margin-left: 4px; }
a { margin-left: 4px; }
.ui-widget-content { /* 	background: url("../../images/slider-controls.png") no-repeat left */
	/* 		center !important; */
	border: 1px solid #AAAAAA; color: #222222; height: 36px !important; border: none; width: 246px !important; top: 12px; height: 34px; border: none }
.ui-widget-content { top: 0; }
.slider-value { position: absolute; }
.slider-controls { height: 32px !important; position: absolute; }
.ui-slider-horizontal .ui-slider-handle { left: 0; top: 16px; background: none !important; margin-top: 5px !important; margin-left: 0px !important; border: 1px solid red !important; }
.page-body { margin-top: -31px; }
.body { border-bottom-right-radius: 80px; }
.output-head { margin-top: -32px; }
</style>
...
<div class="center group">
  ...
  <div id="emergencyReady" >
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/emergency.gif" /> </div>
      <br />
      <br />
  ...
  <div id="cashflowControls" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/cash_flow.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
  ...
  <div id="successionPlan" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainleft" >
        <div id="successPlanQuestion"> </div>
        <div class="action-buttons"> 
          <!-- 							<input class="submit" type="button" --> 
          <!-- 								onClick="saveFinancialStstus();" value="Save" title="Save"> --> 
          <!-- 							<input class="submit" type="button" onClick="openNextPage();" value="Next"> -->
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/succession.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
  ...
  <div id="debtFree" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/loan.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
  ...
  <div id="riskCover" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/risk.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
  ...
  <div id="goalReady" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/goal.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
  ...
  <div id="retirementPlan" style="display: none;">
    <div class="output-body pf-op-body" style="margin-top: 13px;width: 981px;margin-left: 241px;margin-right: 0px;">
      ...
      <div id="mainleft" >
        <div id="retirementPlanQuestion"> </div>
        <b class="errorMessage1" style="float: left;">* MANDATORY FIELD </b>
        <div class="action-buttons"> 
          <!-- 							<input class="submit" type="button" --> 
          <!-- 								onClick="saveFinancialStstus();" value="Save" title="Save"> --> 
      ...
      <div id="mainright"> <img src="<%=request.getContextPath()%>/images/Axis-op/retirement.gif" /> </div>
      <br />
      <br />
      <div class="pf-op-container group">
        <div id="powerby"></div>
