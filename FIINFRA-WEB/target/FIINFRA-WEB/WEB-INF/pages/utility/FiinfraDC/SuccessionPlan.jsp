...
<title>Data Collection - Current Financial Status: Succession Readiness</title>
	...
	<img src="images/currentfstatus.png"  class="img-responsive"> 
          ...
          <div class="panel-body">
            <div class="col-md-11 searchpadding padding_top">
              <ul>
            	<li>More than 1700 crore rupees in bank accounts and over 1.8 lac policies with LIC remain unclaimed because legal heirs of the account holders have not claimed the amount.</li>
                <li>The largest number of cases fought in the family courts pertains to property disputes.</li>
                <li>
There are many ways to distribute assets :through Wills, through Gifts or through Trusts that make the process of bequeath and inheritance legal, easy and hassle free.</li>
