...
public enum Services {
	...
	getPicklistValueList("getPicklistValueList"), insertQuery("insertQuery"), insertQueryComment(
			...
			"saveAnswer"),saveAnswers("saveAnswers"), getPartyProfile("getPartyProfile"), UPDATE_PARTY_INFO(
	...
	"get_user_details"), addLike("addLike"), getAchievementScale(
			...
			getProducts("getProducts"),getFinancialAccounts("getFinancialAccounts"),saveAccount("saveAccount"),getAsset(
					...
					userAccessLog("userAccessLog"), deleteFamilyMembers("deleteFamilyMembers"), getLoanForId("getLoanForId"),

					getIncomeForId("getIncomeForId"), getExpenseForId("getExpenseForId"),getSessionUserByPartyAndToken("getSessionUserByPartyAndToken"), GET_OL_PRODUCT_PURCHASE_URL("GET_OL_PRODUCT_PURCHASE_URL"), URL_GET_COMPANYID("URL_GET_COMPANYID"), URL_GET_PRODUCTID("URL_GET_PRODUCTID"), URL_GET_INVESTORTXNSTARTDATE("URL_GET_INVESTORTXNSTARTDATE");
