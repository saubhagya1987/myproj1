...
<!-- Search start--><div class="modal-body">
			 <form onsubmit="return false" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" name="days" id="days" value="10" maxlength="4" onkeypress="isNumberKey();">
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary " value="Show" title="Show" alt="Show" onClick="getAdvisorWiseClientSIPDueReport(${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
...
<jsp:include page="../common/footer.jsp" />
	...
	<script type="text/javascript">
	 ...
	 function getAdvisorWiseClientSIPDueReport(partyid){
	  ...
	  url =reportLink+"Rpt_SP_AdvisorWiseClientHolding&rs:Command=Render&rc:Parameters=false&partnerId="+partnerId+"&day="+day+"&Party_id="+ClientpartyId+"&Patner_id="+partnerId+"&loggedpartyId="+partnerId+"";
	  callReport(url);
	  ...
	  var objectName ='partnerId::'+partnerId+',Day::'+day+',ClientpartyId::'+ClientpartyId+'PartnerId::'+partnerId+',loggedpartyId::'+partnerId;
	  $.ajax({
			 type :'POST',
...
//				 					        	partyId=ui.item.value;
 ...
 '</div>',
  ...
  $(document).ready(function(){
	  $('#advisorWiseClientSIPDueLink').css('font-weight','bold');
