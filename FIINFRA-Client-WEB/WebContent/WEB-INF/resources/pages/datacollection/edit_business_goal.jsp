					...
					<x:when select="$item/@QuestionType = '85005'">
			            <li class="clearfix rel">
			              ...
			              <div class="input_counter_parent">
			                <input type="text" class="input_counter answers required Number1" name="text__${count.index}" value="${goalMap[attributeCodeId]}" id="text__${count.index}" >
			            ...
			            <li class="clearfix rel">
			              ...
			              <div>
			                ...
			                <x:if select="$item/IsReadOnly = '0'">
			                	<input type="text" class="common_input2 answers required" id="text__${count.index}" name="text__${count.index}" value="${goalMap[attributeCodeId]}" />
			                </x:if>
			              </div>                 
			            </li>	
			        </x:when>	
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('buisnessGoalForm','${cancel}')"><span class="txt">Cancel</span></a></li>
