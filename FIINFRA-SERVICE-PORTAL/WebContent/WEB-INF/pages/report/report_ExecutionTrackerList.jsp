   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Execution Tracker List </a>
...
<script src="<%=request.getContextPath()%>/js/jquery-1.9.1.js"></script> 
	...
	function getExecTrackerList(buid,partyid)
	{		
		  var buId = buid; 
		 ...
		 url="Rpt_SP_ExecutionTrackerList&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedinpartyId+"&nodeId="+nodeId+"";
		 callReport(url);
		  
		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='Execution Reports';
  ...
  <script>
       ...
       function getLastDate(){
     	 ...
     	 function chkform()
	       {
	      	if (document.getElementById("quickSearchpart").value === "" ) 
	         {
	      	...
	      	else
	      		{
	      			...
	      			getExecTrackerList('${sessionScope.userSession.buId}','${sessionScope.userSession.partyId}');
     	 ...
     	 $(document).ready(function(){
     		$('#SPexecutionTrackerListReportLink').css('font-weight','bold');
             
           });
     	   $('#menu-wplook-sub-menu5').addClass('active');	
		   $('#SPReportExecutionLink').addClass('active');
