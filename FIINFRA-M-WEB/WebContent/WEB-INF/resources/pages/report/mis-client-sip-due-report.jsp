      ...
      <input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
        ...
        <div id="client_holding_reort_filter">
            ...
            <li class="six"><label class="fl">Days</label>
                   ...
                   <li class="seven">
                      <input type="submit" value="Search" class="common_btn" onclick="validate(event);getAdvisorWiseClientSIPDueReport(${sessionScope.userSession.partyId})"> 
                      <input type="reset" class="common_btn common_btn_two" onclick="reset()">
                    </li>
...
url =reportLink+"Rpt_PP_AdvisorWiseClientSIPDueReport&rs:Command=Render&rc:Parameters=false&partnerId="+partnerId+"&day="+day+"&Party_id="+ClientpartyId+"&Patner_id="+partnerId+"";
