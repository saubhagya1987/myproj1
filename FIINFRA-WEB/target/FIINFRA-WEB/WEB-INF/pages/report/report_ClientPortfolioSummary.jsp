...
<jsp:include page="../common/footer.jsp" />
	...
	function getClientPortfolioSummary(partyid){
		...
		var partner_id = partyid;
			...
			as_at_date = mn+"-"+day+"-"+yr;
			  ...
			  url ="ClientPortfolioSummary&rs:Command=Render&rc:Parameters=false&as_at_date="+as_at_date+"&PartyID="+ClientpartyId+"&partnerId="+partner_id+"&loggedpartyId="+partner_id+"";
			  callReport(url);
			  var actionByUserID = ${sessionScope.userSession.userId};
			  var sourceModule='Client level';
			  var sourceScreen='Client Portfolio Summary';
  ...
  $(function() {
   ...
   function chkform()
   {
  	if (document.getElementById("quickSearch").value === "" ) 
     {
  	...
  	{
  		getClientPortfolioSummary(${sessionScope.userSession.partyId});
   ...
   $(document).ready(function(){
	   $('#ClientPortFolioSummaryLink').css('font-weight','bold');
