 ...
 <div id="commonpopup-header" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer hide" id="commonpopup-header-footer"> <a  class="btn btn-primary ZebraDialog_Button1 btn-xs" id="commonpopup-header-button-ok">Yes</a> <a  class="btn btn-primary ZebraDialog_Button0 btn-xs" id="commonpopup-header-button-ok">No</a> </div>
    </div>
  </div>
</div>
