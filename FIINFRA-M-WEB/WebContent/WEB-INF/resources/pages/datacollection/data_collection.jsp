      ...
      <section class="in_content clearfix" id="data_collection">
        ...
        <div class="column_right clearfix">
          <div class="current_finacial">
            ...
            <div class="category"  id="retirement_readiness"><c:if test='${retirement == 1 }'><div class="dc_status_comp"></div></c:if><a class="hit_area dcRetirementPlanningLink" href="${pageContext.request.contextPath}/partner/datacollection/retirement-planning/${partyId}"><span>Retirement Readiness</span></a></div>
