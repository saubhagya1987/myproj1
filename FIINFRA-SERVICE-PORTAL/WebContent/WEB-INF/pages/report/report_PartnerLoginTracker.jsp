   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Login Tracker</a>
...
url="Rpt_SP_PartnerLoginTracker&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";
callReport(url);
  var actionByUserID = ${sessionScope.userSession.userId};
  var sourceModule='Security Reports';
  var sourceScreen='Partner Login Tracker';
  ...
  $(document).ready(function(){
	  $('#SPPartnerLoginTrackerReportLink').css('font-weight','bold');
	  bupartyName();
  });
