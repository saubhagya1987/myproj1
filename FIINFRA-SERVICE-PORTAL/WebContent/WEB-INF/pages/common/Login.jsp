...
<!--             <br/> -->
          ...
          <li class="clearfix"><a href="forgotpassword" class="forgot fr"> <br/>Forgot your password?</a></li>
        </ul>
      </form>
         </div>
      </div>
...
id nibh ultricies vehicula ut id elit.</p>
    ...
    <div class="container">
		...
		<div class="leftside margintop">
                	<h2>Videos</h2>
                    <ul>
                    	<li><iframe width="242" height="137" src="http://youtube.com/embed/kk_eU_Sirvc"></iframe></li>
                        <li> <iframe width="242" height="137" src="http://youtube.com/embed/ZEYxRG9Ai90"> </iframe></li>
						<li><iframe width="242" height="137" src="http://youtube.com/embed/GVHq-HlCOxI"></iframe></li>
                    </ul>
        ...
        <div class="rightside margintop">
                    ...
                    <ul>
                    	...
                    	<a href=""> More... </a>    <br>
                        By <img src="images/moneycontrol_logo.png">             
                     </div>    
                     </div>
                </div>
            </div>
