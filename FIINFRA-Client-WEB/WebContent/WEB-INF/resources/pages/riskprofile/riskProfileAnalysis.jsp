...
<div id="risk_proflie_analysis"> 
  <!-- Main starts-->
    ...
    <h3 class="clearfix fl">RISK PROFILE ANALYSIS</h3>
    </div>
    <div id="inner-shadow-strip"></div>
          <section class="in_content common_in_content clearfix analysis_page" id="risk_profile_analysis">
      <div class="analysis_parent">
          ...
          </div><div class="btn_bx"><form>
                        <a href="${pageContext.request.contextPath}/riskProfile/dc/risk-profile/"><input type="button" class="cancel_btn fl" value="CANCEL"></a>
          </form></div>
        </div>
      ...
      <%-- <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          ...
          <!-- <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="#" class="anch add_doc inactiveLink"><span class="txt">Add Doc</span></a></li>
          </ul> -->
