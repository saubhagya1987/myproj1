...
$(window).load(function(){
	...
	function displayNewScreen(){
		$("#frmAssumption").attr('action','${pageContext.request.contextPath}/partner/assetAllocation/fr');
...
<div id="emergency_readiness">
  ...
  <section class="main"> 
	...
	<a href="#" onclick="displayNewScreen();" class="fr asset_allocation_btn">Asset Allocation</a>
  	...
  	<input type="hidden" name="redirectUrl" value="/partner/datacollection/financial-readiness"/>
    <a href="#">
...
$(document).ready(function(){
	...
	if(currentVal != 0 || currentVal2 != 0) {
		$(".asset_allocation_btn").removeClass("inactiveLink");
	} else {
		$(".asset_allocation_btn").addClass("inactiveLink");
	}
