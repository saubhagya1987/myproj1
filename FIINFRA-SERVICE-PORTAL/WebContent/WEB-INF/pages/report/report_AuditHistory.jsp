...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
     ...
     <div class="row">
  		...
  		<div class="col-md-9">
				...
				<div class="list-group">
					<a class="list-group-item active" href="#"> System Audit History </a>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getAuditHistory(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a> 
								</div>
							</div> 
						</div> 
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	function getAuditHistory(buid,partyid)
	{				  
		  var buId = buid; 
		 ...
		 url="Rpt_SP_AuditHistory&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedinpartyId+"";	
		
		 callReport(url);
		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='Security Reports';
		  var sourceScreen='System Audit History';
...
// 					        	partyId=ui.item.value;
   ...
   function resetVal()
  {
   ...
   $(document).ready(function(){
	   $('#SPAuditHistoryReportLink').css('font-weight','bold');
