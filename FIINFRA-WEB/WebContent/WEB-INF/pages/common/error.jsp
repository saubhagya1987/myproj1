	...
	<body>
        ...
        <div style="height:20px"></div>
			<table align="center" class="empty" style="width:80%; height:500px; font-family:arial; font-size:12px; padding:15px 100px 0px 100px;">
			   <tr>
			    <td align="right" ><img alt="" src="../images/finfra_logo.png" /></td>
			  </tr>
			  <tr>
			    <td align="center"><img alt="" src="../images/error-404.jpg" /></td>
			  </tr>
			  <tr>
			    <td align="center" style="font-size: 20px; color: green; font-weight: bold; padding-bottom: 15px;">
			    	...
			    	<br/><br/>
			    	<a href="<%=request.getContextPath()%>">Click Here</a> to go to Home page.
			    </td>
			    <td>
...
<div class="bottomstrip" style="margin-top: 50px !important">
  <div class="container">
    <div id="powerby"><a target="_blank"><img src="../images/finfra_logo.png"> </a>
