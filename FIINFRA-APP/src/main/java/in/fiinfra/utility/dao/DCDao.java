...
public interface DCDao {
	...
	Integer insertDcFinancialStatusRecord(int partyId,int buId,String XMlString,int questionBankId,int sectionTypeId);
	...
	Integer updateDCFutureFinancialExpectationsList(String dataXml, int buId,
			int partyId, int lastModifiedBy);
	
	 List<UserData> getFamilyMemberList(int partyId,int buId);
	 Integer submitDcInput(int partyId,int buId, int lastModifiedBy,boolean isAnalysisReportGenration,boolean isActionPlanGeneration,int analysisReportType);
