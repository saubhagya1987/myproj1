   ...
   <!--div starts  -->      
     <div class="row" >    
  		 <div  class="col-md-3">  
               ...
               <a id="SPContactDeletionTrackerLink" href="loadContactDelTracker.htm" class="list-group-item"> <strong>Contact Deletion Tracker </strong></a>
        </div>  
  		<div class="col-md-9">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Contact Deletion Tracker</a>
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPartnerLoginTracker(${sessionScope.userSession.partyId});resetVal();">
...
<!-- Center part End -->          
  ...
  function getPartnerLoginTracker(partyid){
...
url="ContactDeletionTracker&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";

  callReport(url);

  var actionByUserID = ${sessionScope.userSession.userId};
  var sourceModule='Opportunity Reports';
  var sourceScreen='Contact Deletion Tracker';
  ...
  $(document).ready(function(){
	  $('#SPContactDeletionTrackerLink').css('font-weight','bold');
	  bupartyName();
  });
