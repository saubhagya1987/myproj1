				 ...
				 success: function(msg){
					 $("#productName").empty();
						...
						$.each(msg, function(index, item) {					
							$("#productName").data("selectBox-selectBoxIt").add({ value: item.value, text: item.text });					
						});
...
function setDefaultValues(){
	if("${recordTypeId}"==14003){
		$(".aa_up").html("<spring:message code='vacationPlanning.dataReset' />");
...
<div class="clr"></div>
      ...
      <div class="page_header">
        ...
        <a href="#" onclick="setDefaultValues();" class="set_default saveVacationPlanningLink"><span class="set_default_txt">Set Default </span></a>        
          ...
          <span class="head_txt">Vacation Planning</span><span class="heading_icon"><span class="head_icon"><img src="${pageContext.request.contextPath}/resources/images/vacation_advice.png" alt="" vspace="9" class="rp-margin"/></span></span></h1>
      </div>
    </header>
    <!-- Header Ends--> 
    ...
    <jsp:include page="../layout/submenu_small.jsp"></jsp:include>
     <!-- Common_in_contnet starts-->
      ...
      <form method="post" name="vacationPlanningform" id="vacationPlanningform" action="<c:url value="/partner/saveVacationPlanings"/>">
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            <c:if test="${sessionScope.userSession.buId!='27829' || (sessionScope.userSession.buId=='27829' && sessionScope.userSession.roleId=='212')}">
            	<li class="fl list"><a href="#" class="anch save saveVacationPlanningLink" onclick="formSubmit();"><span class="txt">Save</span></a></li>
            </c:if>
            <li class="fl list"><a href="#" class="anch cancel" onclick="formCancel();"><span class="txt">Cancel</span></a></li>
            <!-- <li class="fl list"><a href="succession-planning.html" class="anch skip"><span class="txt">Skip</span></a></li> -->
          </ul>
        </div>
