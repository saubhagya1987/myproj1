						...
						<!-- <div class="modal-footer"> -->
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="chkform();">
								</a>
								</div>
							</div> 
						</div>
...
<!-- Center part End -->           
	...
	<script type="text/javascript">
	 ...
	 function getAdvisorwiseClientPortfolioSummary(partyid){
			
		    var PartnerId = $('#quickSearchHiddenpart').val();
			var as_at_date1 = $('#datepicker').val();
			var ClientpartyId = $('#quickSearchHidden').val();
			var nodeId=0;
	  
		
			
			var dt = as_at_date1.split("-");
			var day = dt[0];
			var mn = dt[1];
			var yr = dt[2];
			as_at_date = mn+"-"+day+"-"+yr;
		...
		url ="Rpt_SP_AdvisorwiseClientPortfolioSummary&rs:Command=Render&rc:Parameters=false&as_on_date="+as_at_date+"&partner_id="+PartnerId+"&PartyID="+ClientpartyId+"&partnerId="+PartnerId+"&nodeId="+nodeId+"&loggedpartyId="+partyid+"";
	  ...
	  var objectName ='As_on_date::'+as_at_date1+',PartnerId::'+PartnerId+',ClientpartyId::'+ClientpartyId+',PartnerId::'+PartnerId+',nodeId::'+nodeId+', loggedpartyId:: '+partyid;
	  $.ajax({
			 type :'POST',
...
// 					     
  ...
  $(function() {
   ...
   function chkform()
   {
  	if (document.getElementById("quickSearchpart").value === "" ) 
     {
  	...
  	else
  	{
  		...
  		getAdvisorwiseClientPortfolioSummary(partyid);
   ...
   $(document).ready(function(){
	   $('#SPPortfolioSummaryReportLink').css('font-weight','bold');
