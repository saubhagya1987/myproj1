...
#analysis_report_content .client_details .category_ul .second .category { background:url(${pageContext.request.contextPath}/resources/images/risk_profile_report.png) no-repeat center center #fff;background-size: 60%; }
...
#analysis_report_content .client_details .category_ul .fifth .category { background: url(${pageContext.request.contextPath}/resources/images/succsession_report.png) no-repeat center center #fff }
...
<div class="wrapper">
  ...
  <br><p class="secondary_heading" style="margin-top: -10px;">Goals - My Dreams</p>		
