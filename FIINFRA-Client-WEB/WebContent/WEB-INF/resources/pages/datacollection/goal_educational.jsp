	...
	<section class="main">
		...
		<section class="content common_content">
			...
			<form class="form-horizontal" id="frmEductionGoal" name="frmEductionGoal" action="<c:url value="/futureFinancialDc/saveEductionGoal" />" method="POST">
				...
				<section id="education_goal"
					class="in_content common_in_content clearfix education_goal">
					...
					<x:forEach select="$output/Section/Question" var="item"
						...
						<x:choose>
							...
							<x:when select="$item/@QuestionType = '85004'">
								<li class="clearfix rel"><input type="hidden"
									name="parentId" id="parentId" value="0" /> <label
									class="form_label"><x:out select="QuestionText" /></label> <select
									id="brand_${count.index}" name="brand_${count.index}">
								</select></li>
						  ...
						  // brand_1 for education_for
							...
							<x:when select="$item/@QuestionType = '85005'">
								<li class="clearfix rel"><label class="form_label"
									id="edu_exp"><x:out select="QuestionText" /> </label>
									...
									<div class="range_parent">
										<div class="scale clearfix">
											...
											<input type="text" id="sliderValue_${count.index}"
												name="sliderValue_${count.index}"
												class="range_counter answers required 
	...
	<li class="clearfix rel"><label class="form_label"><x:out
		...
		<div>
			...
			<x:if select="$item/IsReadOnly = '1'">
				<input type="text" disabled class="fixed_txt_box answers required"
...
<!-- Common footer starts -->
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
         ...
         <li class="fl list"><a href="javascript:void()" class="anch cancel" onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Cancel</span></a></li>
           
          </ul>
          
        </div>
        <a href="javascript:void(0);" class="back navgation" onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Back</span></a>
		<a href="javascript:void(0);" class="next navgation" onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/futureFinancialDc/property-goal')"><span class="txt">Next</span></a> 
       </section>
</form>      
      <!-- Common footer ends --> 
...
$(window).load(function(){
	  ...
	  $(function() {
			...
			jsonPopulateAutoComplete("${pageContext.request.contextPath}/common/codevalues?codeTypeId=CountryForGoal", '{}', "#auto__2", "auto__2", '${goalMap[attributeCodeId]}');
