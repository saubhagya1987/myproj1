						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary " value="Show" title="Show" alt="Show" onClick="getAdvisorWiseClientFolioMissingNomination(${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
...
<jsp:include page="../common/footer.jsp" />
	...
	<script type="text/javascript">
	 ...
	 function getAdvisorWiseClientFolioMissingNomination(partyid){
	  ...
	  url ="AdvisorWiseClientFolioMissingNomination&rs:Command=Render&rc:Parameters=false&partnerId="+partnerId+"&partyId="+ClientpartyId+"&loggedpartyId="+partnerId+"";
	  callReport(url);
	  ...
	  var objectName ='PartnerId::'+partnerId+',ClientpartyId::'+ClientpartyId+',loggedpartyId::'+partnerId;
	  $.ajax({
			 type :'POST',
 ...
 '</div>',
  ...
  {    
   ...
   $(document).ready(function(){
	   $('#advisorWiseClientFolioMissingNominationLink').css('font-weight','bold');
