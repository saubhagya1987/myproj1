   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Activity MIS</a>
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPartnerActivityMIS(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a> 
								</div>
							</div> 
						</div> 
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	<script type="text/javascript">
	  ...
	  $(document).ready(function(){
		  $('#SPPartnerActivityMISReportLink').css('font-weight','bold');
		  
  	});
	  
	
			function getPartnerActivityMIS(buid,partyid){
				var buId=buid;
			...
			var url="Rpt_SP_PartnerActivityMIS&rs:Command=Render&rc:Parameters=false&partnerId="+PartnerId+"&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+partyid+""
			callReport(url);
			 
			  var actionByUserID = ${sessionScope.userSession.userId};
			  var sourceModule='Partner MIS Reports';
			  var sourceScreen='Partner Activity MIS';
			  var objectName ='PartnerId::'+PartnerId+',BusinessUnit::'+buId+',StartDate::'+StartDate1+',EndDate::'+EndDate1+',loggedpartyId::'+loggedpartyId;
			  $.ajax({
					 type :'POST',
