...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
   ...
   <!--div starts  -->      
     <div class="row">
			...
			<div class=" col-md-3 sidebar-offcanvas" role="navigation"
                ...
                <a href="loadreportClientGoalSummary.htm" class="list-group-item" id="clientGoalSummaryReportLink"><strong>Client Goal Summary Report</strong> </a>
              	<!-- <a href="loadreportClientGoalDetails.htm" class="list-group-item" href="#" id="clientGoalDetailsReportLink">Client Goal Detail Report</a> -->
				</div>
			</div>
			<div class="col-md-9"> 
				...
				<form class="form-horizontal" role="form" onsubmit="return false">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getClientSummary(${sessionScope.userSession.buId},${sessionScope.userSession.partyId},${sessionScope.nodeId});resetVal();">
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>
  ...
  function getClientSummary(buid,partyid,nodeId){
	  ...
	  var objectName = buId+','+partyid+','+ClientpartyId+','+partyid+',NodeId'+nodeId;
	  $.ajax({
			 type :'POST',
