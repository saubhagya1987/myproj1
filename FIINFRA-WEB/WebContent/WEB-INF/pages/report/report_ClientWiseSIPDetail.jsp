   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">SIP Detail Report</a>
 ...
 function getClientTransactionStatement(partyid){
		...
		var partner_id = partyid;
					...
					as_at_date = mn+"-"+day+"-"+yr;
					  ...
					  url ="ClientWiseSIPDetails&rs:Command=Render&rc:Parameters=false&as_at_date="+as_at_date+"&PartyID="+ClientpartyId+"&partnerId="+partner_id+"&loggedpartyId="+partner_id+"";
					  callReport(url);
					  var actionByUserID = ${sessionScope.userSession.userId};
					  var sourceModule='Client level';
					  var sourceScreen='Client Wise SIP Details';
...
//			 					        	partyId=ui.item.value;
	 ...
	 function chkform()
	  ...
	  $(document).ready(function(){
		  $('#ClientSTLTTaxLink').css('font-weight','bold');
