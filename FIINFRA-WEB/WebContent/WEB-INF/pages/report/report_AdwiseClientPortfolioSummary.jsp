   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Portfolio Summary - Unrealized gain</a>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary " value="Show" title="Show" alt="Show" onClick="getAdvisorwiseClientPortfolioSummary(${sessionScope.userSession.partyId},${sessionScope.nodeId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
...
<jsp:include page="../common/footer.jsp" />
	...
	<script type="text/javascript">
	 ...
	 function getAdvisorwiseClientPortfolioSummary(partyid,nodeId){
			
		    var as_on_date = $('#datepicker').val();
	  ...
	  url ="AdvisorwiseClientPortfolioSummary&rs:Command=Render&rc:Parameters=false&as_on_date="+as_on_date+"&partner_id="+partner_id+"&PartyID="+ClientpartyId+"&partnerId="+partner_id+"&nodeId="+nodeId+"&loggedpartyId="+partner_id+"";
	
	  callReport(url);
	 
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='Advisorwise level';
	  var sourceScreen='Advisor wise Client Portfolio Summary';
	  var objectName ='AsOndate::'+as_on_date+',PartnerId::'+partner_id+',ClientpartyId::'+ClientpartyId+',PartnerId::'+partner_id+',NodeId'+nodeId+',loggedpartyId::'+partnerId;
	  $.ajax({
			 type :'POST',
...
//				 					        	partyId=ui.item.value;
 ...
 '</div>',
   ...
   $(document).ready(function(){
	   $('#advisorWiseClientPortFolioSummaryLink').css('font-weight','bold');
