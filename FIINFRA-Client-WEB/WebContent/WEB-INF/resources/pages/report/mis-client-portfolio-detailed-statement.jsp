...
<!--                     </li> -->
            ...
            <li>
                      <input type="submit" value="Search" class="common_btn" onclick="validate(event);getClientPorDetailedSt('ClientPortfolioDetailStatement.rptdesign','${sessionScope.userSession.partyId}')">
                    </li>
          </ul>
       ...
       <div id="downloadOptions" align="right" style="display: none;margin-right: 30px;">
					...
					<br><br>
					Download Report as:
					  <a class="pdficon" title="Download in Pdf" alt="Download in Pdf"href="#" onclick="downClientPorDetailedSt('pdf','${sessionScope.userSession.partyId}')"></a>
					 <a class="excelicon" title="Download in Excel" alt="Download in Excel"href="#" onclick="downClientPorDetailedSt('xls','${sessionScope.userSession.partyId}')"></a>
					 <a class="docicon" title="Download in Doc" alt="Download in Doc" href="#" onclick="downClientPorDetailedSt('doc','${sessionScope.userSession.partyId}')"></a>
				</div>
