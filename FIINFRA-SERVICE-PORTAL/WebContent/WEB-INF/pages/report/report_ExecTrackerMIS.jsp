...
<script src="<%=request.getContextPath()%>/js/jquery-1.9.1.js"></script> 
	...
	function execTrackerMIS(buid,partyid)
	{
		  var buId = buid; 
		 ...
		 url="Rpt_SP_ExecutionTrackerMIS&rs:Command=Render&rc:Parameters=false&buId="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&loggedpartyId="+loggedinpartyId+"&nodeId="+nodeId+"";
...
function getCurrentDate(){
   ...
   function resetVal()
  {
   ...
   function chkform()
   {
  	if (document.getElementById("quickSearchpart").value === "" ) 
     {
  	...
  	else
  		{
  			...
  			execTrackerMIS('${sessionScope.userSession.buId}','${sessionScope.userSession.partyId}');
   ...
   $(document).ready(function(){
	   $('#SPexecutionTrackerMISLink').css('font-weight','bold');
