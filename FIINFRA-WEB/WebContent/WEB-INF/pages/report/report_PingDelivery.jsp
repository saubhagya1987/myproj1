...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
   ...
   <!--div starts  -->      
			...
			<div class=" col-md-3 sidebar-offcanvas" role="navigation"
				...
				<div class="list-group">
					<a class="list-group-item active" href="#">Ping Reports</a> <a
						...
						id="pingDeliveryReportLink"><strong> Ping Delivery
							Report </strong></a> <a href="loadPingMISReport.htm" class="list-group-item"
						href="#" id="pingMISReportLink">Ping MIS Report</a> <a
				...
				<form class="form-horizontal" role="form"
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPingDelivery(${sessionScope.userSession.partyId},${sessionScope.userSession.buId},${sessionScope.nodeId})">
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>	
	...
	function getPingDelivery(partyid,buid,nodeId)
	{
		  var buId = buid;
		...
		/*   var reportLink= $('#abc').val(); */
		  url="PingDeliveryReport&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"&nodeId="+nodeId+"";
		  callReport(url);
		  ...
		  */
		  ...
		  var sourceScreen='Ping Delivery Report';
