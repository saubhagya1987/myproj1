   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner-Wise Goal MIS </a>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getClientSummary(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div>
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	var url="Rpt_SP_Partner-wiseGoalMIS&rs:Command=Render&rc:Parameters=false&buId="+buId+"&partnerId="+PartnerId+"&partyId="+ClientpartyId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+partyid+"";
	callReport(url);
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='Goal Reports';
	  var sourceScreen='Partner-wise Goal MIS';
	  var objectName = 'BussinessUnitID::'+buId+', PartnerPartyID::'+PartnerId+', ClientPartyID::'+ClientpartyId+', StartDate::'+StartDate1+', EndDate::'+EndDate1+', LoggedInPartyID::'+partyid;
