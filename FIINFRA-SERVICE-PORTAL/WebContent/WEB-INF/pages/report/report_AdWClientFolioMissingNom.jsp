   ...
   <!--div starts  -->       
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Nomination Missing Folios</a>
          ...
          <form onsubmit="return false" class="form-horizontal">
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="space-2"></div>
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<a href="#" style="color: #fff;"onClick="">
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="chkform();resetVal();"></a>
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>
							...
							<%-- <tr>
								<td><span class="style1"><b>Partner Name </b></span></td>
								<td><input name="text" type="text" id="quickSearchpart" name="searchString" onKeyUp="quickSearchPartner(this);"placeholder="Quick Search" style="width: 300px;">
								
								<input name="text" type="hidden" id="quickSearchHiddenpart" name="searchString"  placeholder="Quick Search" style="width: 300px;"></td>
							
								<td><div id="er1"></div></td>
							</tr>
							<tr class="spacer"><td></td></tr>
							<tr class="spacer"><td></td></tr>
						 
							<tr>
								<td><span class="style1"><b>Client Name </b></span></td>
								<td><input name="text" type="text" id="quickSearch" name="searchString" onKeyUp="quickSearchContacts(this);" placeholder="Quick Search" style="width: 300px;">
								<input name="text" type="hidden" id="quickSearchHidden" name="searchString"  placeholder="Quick Search" style="width: 300px;"></td>
							...
							<tr>
								...
								onClick="">
								<input type="button" class="dbtn" value="Show" title="Show"
								alt="Show" onClick="chkform()">
								</a> </td>
							</tr> --%>								
...
<!-- Center part End -->           
	...
	function getAdvisorWiseClientFolioMissingNomination(partyid){
		...
		url ="Rpt_SP_AdvisorWiseClientFolioMissingNomination&rs:Command=Render&rc:Parameters=false&partnerId="+PartnerId+"&partyId="+ClientpartyId+"&loggedpartyId="+partyid+"";
	
	  callReport(url);
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='Advisor level';
	  var sourceScreen='Advisor Wise Client Folio Missing Nomination';
	  var objectName ='PartnerId::'+PartnerId+',ClientpartyId::'+ClientpartyId+', loggedpartyId:: '+partyid;
	  $.ajax({
			 type :'POST',
    	...
    	$("#popUpAlertaddnote").css ('width','1100px');
           ...
           function chkform()
           {
          	if (document.getElementById("quickSearchpart").value === "" ) 
             {
          	...
          	{
          		getAdvisorWiseClientFolioMissingNomination(${sessionScope.userSession.partyId});
           ...
           $(document).ready(function(){
        	   $('#SPFolioMissingNominationReportLink').css('font-weight','bold');
