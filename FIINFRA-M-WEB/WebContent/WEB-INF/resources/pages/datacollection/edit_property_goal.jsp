...
<div id="">
	...
	<div class="main-content">
     ...
     <form class="form-horizontal" id="propertyGoalFormId" name="propertyGoalForm" action="<c:url value="/futureFinancialDc/savePropertyGoal" />" method="POST">
      			...
      			<x:choose>
					...
					<x:when select="$item/@QuestionType = '85004'">
			            ...
			            <script type="text/javascript">			           
					   		...
					   		else if(attrId == 100051)// for goal yesr
						   	{
	...
	<div class="row">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-4 col-xs-4 test">
				<button
					class="btn btn-app btn-transparent btn-xs analysis " onclick="doValidate('propertyGoalFormId','${pageContext.request.contextPath}/analysis/property/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-search bigger-200"></i> Analysis
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs suggeset " onclick="doValidate('propertyGoalFormId','${pageContext.request.contextPath}/analysis/suggestion/property/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-lightbulb-o bigger-200"></i> Suggestion
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs action_plan " onclick="doValidate('propertyGoalFormId','${pageContext.request.contextPath}/actionplan/goal/property/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-hand-o-up bigger-200"></i> Action Plan
				</button>
			</div>
			<div class="col-sm-3 col-xs-4">
				<button class="btn btn-app btn-transparent btn-xs " onclick="uploadNote(${goalId},${partyId},'/futureFinancialDc/edit-property-goal/${goalId}/${partyId}');">
				  <c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/edit-property-goal/${goalId}/${partyId}"/>
			...
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveEditPropertyGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('propertyGoalFormId','${cancel}')">
...
$("#car_type").on('toggle', function (e, active) {
 ...
 // auto slider
     ...
     // on load change html
     var text6 = parseFloat( $("#sliderValue_8").val()) +  parseFloat($("#sliderValue_9").val());
     		 $("#slider_8").slider("option", "max", parseFloat($("#text__7").val()));
    	     $("#slider_9").slider("option", "max", parseFloat($("#text__7").val()));
    	     $("#sliderMaxValue_8").html($("#text__7").val());
    	     $("#sliderMaxValue_9").html($("#text__7").val());
