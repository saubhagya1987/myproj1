...
<div id="Global_Goal"> 
  ...
  <section class="main"> 
    ...
    <jsp:include page="../layout/dc_submenu.jsp"></jsp:include> 
     ...
     <form class="form-horizontal" id="targetCorpusGoalForm" name="targetCorpusGoalForm" action="<c:url value="/whatIf/saveTargetCorpusGoal" />" method="POST">
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="javascript:void(0);" onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/whatIf/graph/${partyId}')" class="anch cancel" style="margin-right: 260px;"><span class="txt">Cancel</span></a></li>
          </ul>
        </section>
