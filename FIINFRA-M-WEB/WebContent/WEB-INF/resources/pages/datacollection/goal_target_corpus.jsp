	...
	<div class="row">
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/futureFinancialDc/special-goal/${partyId}')">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-3 col-xs-4">
				...
				<button
					...
					<c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/target-corpus-goal/${goalId}/${partyId}"/>
					<i class="ace-icon fa fa-newspaper-o bigger-200"></i> Doc
				</button>
			</div>
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveAddTargetCorpusGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/partner/datacollection/${partyId}/<%=request.getSession().getAttribute("headerName")%>/2')">
		...
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('targetCorpusGoalForm','${pageContext.request.contextPath}/futureFinancialDc/other-goal/${partyId}')">
