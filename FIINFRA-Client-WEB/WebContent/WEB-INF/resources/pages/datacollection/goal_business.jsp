...
<div id="Global_Goal"> 
  ...
  <section class="main">
    ...
    <section class="common_unit_selector"><ul class="clearfix reset"><!-- <li class="k"><span class="unit">K</span></li> --><li class="lacs unit_selected"><span class="unit">Lac</span></li><!-- <li class="cr"><span class="unit">Cr</span></li> --></ul><p>All figures are in :</p></section>
     ...
     <form class="form-horizontal" id="buisnessGoalForm" name=buisnessGoalForm action="<c:url value="/futureFinancialDc/save-business-goal" />" method="POST" onsubmit="return validateGoalName()">
      			...
      			<x:choose>
					...
					<x:when select="$item/@QuestionType = '85004'">
			          ...
			          <script type="text/javascript">			           
						   	...
						   	{
					   			$("select").selectBoxIt();
					   			jsonPopulateDropdown("${pageContext.request.contextPath}/common/codevalues?codeTypeId=BusinessType", '', "#brand_"+${count.index}, "#brand_"+${count.index}, '${goalMap[attributeCodeId]}');
					   		   	
						   	}
					   		else if(dropDownName=='#brand_2')
						   	{
					   			$("select").selectBoxIt();
					   			jsonPopulateDropdown("${pageContext.request.contextPath}/common/codevalues?codeTypeId=Ownership", '', "#brand_"+${count.index}, "#brand_"+${count.index}, '${goalMap[attributeCodeId]}');
					...
					<x:when select="$item/@QuestionType = '85005'">
			            <li class="clearfix rel">
			              ...
			              <div class="input_counter_parent">
			                <input type="text" class="input_counter answers required Number1" name="text__${count.index}" value="00" id="text__${count.index}" >
			              ...
			              <div class="range_parent">
			    			...
			    			<script type="text/javascript">
			    				...
			    				if(sliderVar == '#slider_9') {
			    					createSliderAndSetValue(sliderVar, <x:out select="$item/Scale/Min_Value" />, <x:out select="$item/Scale/Max_Value" />, <x:out select="$item/Scale/Increment" />,sliderValueVar,"15");
			    				}
			    				else {
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            <li class="fl list"><a href="#" class="anch save"><span class="txt">Save</span></a></li>
           	<li class="fl list"><a href="javascript:void()" class="anch cancel" onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Cancel</span></a></li>
         
          </ul>
          
        </div>
        <a href="javascript:void(0);" class="back navgation" onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/futureFinancialDc/travel-vacation-goal')"><span class="txt">Back</span></a>
		<a href="javascript:void(0);" class="next navgation" onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/futureFinancialDc/special-goal')"><span class="txt">Next</span></a> 
       </section>
</form>      
      <!-- Common footer ends --> 
...
$(document).ready(function(){
	...
	$("#goalName").val("Business Goal");
	$("#hiddenGoalName").val("Business Goal");
