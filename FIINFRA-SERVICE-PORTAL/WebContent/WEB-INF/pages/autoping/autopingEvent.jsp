...
<%-- <jsp:include page="../common/common_popup.jsp" /> --%>
 <div class="page-header">
		<h1 class="pull-left">Auto Ping Event</h1>
	...
	<div class="row">
  		...
  		<div class="list-group">
        			<a class="list-group-item active" href="#">Auto Ping Event List  </a>
...
function changePageSize(){
	var searchtext=$('#searchtext').val();
 	$("#toreload").load('${pageContext.request.contextPath}/autoping/getAutoPingEvent.htm #toreload', {
	   object: '${object}',
	   pageSize: $('#page').val(),
...
function getXLS()
{
	 	...
	 	window.location.href = "<%=request.getContextPath()%>/autoping/eventExport.htm?type=excel"; 
}
function getCSV()
{
		window.location.href = "<%=request.getContextPath()%>/autoping/eventExport.htm?type=CSV";
}

$(function() {
	$('#SPAutoPingEventListLink').css('font-weight','bold');
})
			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:['Event','EventDescription','Source','LastModifiedDate','EventCreatedBy'],
					colModel:[
						...
						{name:'eventDescription',index:'eventDescription'},
						{name:'source',index:'source'},
						{name:'lastModifiedDate',index:'lastModifiedDate'},
						{name:'eventCreatedBy',index:'eventCreatedBy'} 
					], 
...
<form id="autopingForm">
	<!-- <input type="text" id="notifyTemplateIdToSend" name="pingId"/> -->
