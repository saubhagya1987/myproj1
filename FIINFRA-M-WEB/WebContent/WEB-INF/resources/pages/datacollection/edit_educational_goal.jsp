								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-xs-10">
										<div class="input_counter_parent">
											<input type="text" name="text__${count.index}" value="${goalMap[attributeCodeId]}"
												class="input_counter answers required Number1" 
	...
	<div class="row">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-4 col-xs-4 test">
				<button
					class="btn btn-app btn-transparent btn-xs analysis " onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/analysis/education/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-search bigger-200"></i> Analysis
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs suggeset " onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/analysis/suggestion/education/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-lightbulb-o bigger-200"></i> Suggestion
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs action_plan " onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/actionplan/goal/educational/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-hand-o-up bigger-200"></i> Action Plan
				</button>
			</div>
			<div class="col-sm-3 col-xs-4">
				<button class="btn btn-app btn-transparent btn-xs " onclick="uploadNote(${goalId},${partyId},'/futureFinancialDc/edit-educational-goal/${goalId}/${partyId}');">
				<c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/edit-educational-goal/${goalId}/${partyId}"/>
					<i class="ace-icon fa fa-file-code-o bigger-200"></i> Notes
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs dcAddNewDocumentLink"
					onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/partner/addDocument${docUrl}');" >
					<i class="ace-icon fa fa-newspaper-o bigger-200"></i> Doc
				</button>
			</div>
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveEditEducationGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('frmEductionGoal','${cancel}')">
