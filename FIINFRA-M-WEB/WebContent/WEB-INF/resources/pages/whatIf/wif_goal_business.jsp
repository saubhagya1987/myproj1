...
<div id="">
	...
	<div class="main-content">
       ...
       <form class="form-horizontal" id="buisnessGoalForm" name=buisnessGoalForm action="<c:url value="/whatIf/save-business-goal" />" method="POST">
      ...
      <%-- <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="javascript:void(0);" class="anch cancel" style="margin-right: 260px;" onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/whatIf/graph/${partyId}')"><span class="txt">Cancel</span></a></li>
          </ul>
        </section> --%>
	...
	<div class="col-sm-4 col-xs-4 "></div>
		<div class="col-sm-3 col-xs-4">
			...
			<button class="btn btn-app btn-transparent btn-xs cancel"
				onclick="doValidate('buisnessGoalForm','${pageContext.request.contextPath}/whatIf/graph/${partyId}')">
     ...
     if($("#hiddenGoalName").val()=="" || $("#hiddenGoalName").val()==null)
 	 {
    	...
    	$("#slider_9").slider("value",15);
        $("#sliderValue_9").val(15);
