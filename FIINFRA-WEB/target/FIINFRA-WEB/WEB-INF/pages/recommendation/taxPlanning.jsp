...
.heading_icon{line-height: 61px !important;}
</style>
<style>
/* #confirmDialog {
display: block;
  ...
  <section class="main"> 
    ...
    <header class="common_header inner_header">
      ...
      <div class="page_header">
        <h1 class="heading clearfix">
          ...
          <span class="head_txt">Tax Planning</span><span class="heading_icon"><i class="ace-icon fa icon-tax-planning bigger-100"></i></span>
    ...
    <!-- Common_content Starts--><section class="content common_content">
     ...
     <div class="space hidden-xs"></div>
      <secDtion class="in_content common_in_content clearfix my_profile_parent" id="vaccation_planning">
      <form method="post" name="vacationPlanningform" id="vacationPlanningform" action="<c:url value="/partner/saveTaxPlanings.htm"/>">
      ...
      <section class="common_footer_actions">
							<div class="row">
								<div class="col-sm-1 col-xs-3">
									<a href="${pageContext.request.contextPath}/partner/recommendation/loans.htm"><div class="btn btn-app btn-transparent btn-xs" >
      ...
      <%-- <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
           <c:choose>
        		<c:when test="${sessionScope.userSession.buId!='27829' || (sessionScope.userSession.buId=='27829' && sessionScope.userSession.roleId=='212')}">
             <li class="fl list"><a href="#" class="saveTaxPlanningPlanningLink" onclick="formSubmit();"><input class="dbtn" value="Save" type="button"></a></li>
             </c:when>
             </c:choose>
...
<!--             <li class="fl list"><a href="#" class=" "><input class="dbtn" value="Skip" type="button"></a></li> -->
        ...
        <a href="${pageContext.request.contextPath}/partner/recommendation/loans.htm" class="back navgation" ><input class="dbtn" value="Back" type="button"></a> 
        <a href="${pageContext.request.contextPath}/partner/vacationPlanning.htm" class="next navgation" ><input class="dbtn" value="Next" type="button">
        </section> --%>
      <!-- Common footer ends -->
...
$(document).ready(function(){
	...
	function formCancel(){
		...
		if(($("#productCategoryValuesInitial").val() != $("#productCategoryValuesFinal").val()) || ($("#companyNameValuesInitial").val() != $("#companyNameValuesFinal").val()) ||
			...
			confirmCancel("The data has changed. Are you sure you want to exit.");			
		} else {
			$('#vacationPlanningform').attr('action', '${pageContext.request.contextPath}/partner/recommendation');
			$("#vacationPlanningform").submit();
		}
