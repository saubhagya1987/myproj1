    ...
    <section class="content common_content">
      ...
      <section class="in_content clearfix" id="data_collection">
        ...
        <div class="column_left">
          <div class="first_col">
            <div id="personal_info" class="circular_bg"><a class="hit_area dcPersonalInformationLink" href="${pageContext.request.contextPath}/partner/profile/${partyId}/${headerName}"><span>Personal Information</span></a></div>
          </div>
          <div class="sec_col">
            <div id="risk_profile" class="circular_bg"><a class="hit_area dcRiskProfileLink" href="${pageContext.request.contextPath}/riskProfile/datacollection/risk-profile/${partyId}"><span>Risk Profile</span>
        ...
        <div class="column_right clearfix">
          <div class="current_finacial">
            <div class="heading fr clearfix">
              ...
              <div class="clr"></div>
            <div class="category" id="cash_flow"><a class="hit_area dcCashFlowLink" href="${pageContext.request.contextPath}/partner/datacollection/cash-flow/${partyId}"><span>Cash Flow</span></a></div>
            <div class="category inactiveLink" id="risk_cover"><a class="hit_area dcRiskCoverLink" href="${pageContext.request.contextPath}/partner/datacollection/risk-cover/${partyId}"><span>Risk Cover</span></a></div>
            <div class="category" id="goal_readiness"><a class="hit_area dcGoalReadinessLink" href="${pageContext.request.contextPath}/partner/datacollection/financial-readiness/${partyId}"><span>Goal Readiness</span></a></div>
            <div class="category"  id="retirement_readiness"><a class="hit_area dcRetirementPlanningLink" href="${pageContext.request.contextPath}/partner/datacollection/retirement-planning/${partyId}"><span>Retirement Readiness</span></a></div>
            <div class="category inactiveLink" id="emergency"><a class="hit_area dcEmergencyReadinessLink" href="${pageContext.request.contextPath}/partner/datacollection/emergency-readiness/${partyId}"><span>Emergency</span></a></div>            
