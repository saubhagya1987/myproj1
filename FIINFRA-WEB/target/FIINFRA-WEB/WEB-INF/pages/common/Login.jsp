...
<div id="logo_f" class="logo" style="background:url('<%=request.getContextPath()%>/images/BU_Logo.png') no-repeat;background-size:100% !important;width: 250px;height: 30px;margin-left: 10px;"></div>
 <div class="row">
...
<!--               <span id="custom_check" class="custom_check"></span> <span class="remember_txt">Remember me</span> </div> -->
          ...
          <li class="clearfix"><a href="forgotPassword.htm" class="forgot fr" > <br/>Forgot your password?</a></li>
          <li><br/>
...
id nibh ultricies vehicula ut id elit.</p>
    ...
    <div class="container">
		...
		<div class="leftside margintop">
                	<h2>Videos</h2>
                    <ul>
                    	<li><iframe width="242" height="137" src="https://www.youtube.com/embed/kk_eU_Sirvc"></iframe></li>
                        <li> <iframe width="242" height="137" src="https://www.youtube.com/embed/watch?v=eNAtKbANBQs&list=PLEhtzo1XHPL28nGTRC-jCwunH8rq3sgrE&feature=share&index=1"> </iframe></li>
						<li><iframe width="242" height="137" src="https://www.youtube.com/embed/939muCoVIy4"></iframe></li>
...
<!-- 	</table> -->
                    ...
                    <ul id="rssFeeds">
                   	<li><a target="_blank" href="http://axismf.com/Downloads/BondMarketReview_Axis.pdf">Get an update on debt markets</a></li>
                   	<li><a target="_blank" href="http://axismf.com/Mutual-Fund/Index.aspx ">Planning for child education? Try Pehla Kadam</a></li>
                   	<li><a target="_blank" href="http://axismf.com/Mutual-Fund/Funda-Singhs-Fundas.aspx">Know Funda Singh's Fundas</a></li>
                   	<li><a target="_blank" href="http://axismf.com/common/kalse.aspx">Understand how compound interest affects you with Kal Se calculator</a></li>
                   	<li><a target="_blank" href="http://axismf.com/common/powerof1000.aspx">See the difference those extra 1000 rupees make in the long run. Try</a></li>
                   	<li><a target="_blank" href="http://axismf.com/Flash/EatingoutTool.html">Did you know that cutting down on just 1 outing a month starting from age 25 could get you? Try Eating Out calculator</a></li>
                    </ul>
