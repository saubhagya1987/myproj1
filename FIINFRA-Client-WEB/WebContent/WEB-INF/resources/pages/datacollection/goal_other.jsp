...
<div id="Global_Goal"> 
  ...
  <section class="main"> 
    ...
    <jsp:include page="../layout/dc_submenu.jsp"></jsp:include> 
     <section class="common_unit_selector"><ul class="clearfix reset"><!-- <li class="k" onclick="doAction('k')"><span class="unit">K</span></li> --><li class="lacs unit_selected" onclick="doAction('lacs')"><span class="unit">Lac</span></li><!-- <li class="cr" onclick="doAction('cr')" ><span class="unit">Cr</span></li> --></ul><p>All figures are in :</p></section>
      <div class="clr"></div>
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="javascript:void()" class="anch cancel" onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Cancel</span></a></li>
           
          </ul>
         
        </div>
        <a href="javascript:void(0)" class="back navgation" onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/futureFinancialDc/special-goal')"><span class="txt">Back</span></a> 
        <a href="javascript:void(0)" class="next navgation" onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/partner/datacollection')"><span class="txt">Next</span></a> 
        </section>
            <!-- Common footer ends -->
    </section>
    <!-- Common_content Ends-->
