...
<div id="">
	...
	<div class="main-content">
     ...
     <form class="form-horizontal" id="specialGoalForm" name="specialGoalForm" action="<c:url value="/whatIf/saveSpecialGoal" />" method="POST">
  ...
  <%--     <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="javascript:void(0);" onclick="doValidate('specialGoalForm','${pageContext.request.contextPath}/whatIf/graph/${partyId}')" class="anch cancel" style="margin-right: 260px;"><span class="txt">Cancel</span></a></li>
          </ul>
        </section> --%>
	...
	<div class="col-sm-4 col-xs-4 "></div>
		<div class="col-sm-3 col-xs-4">
			...
			<button class="btn btn-app btn-transparent btn-xs cancel"
				 onclick="doValidate('specialGoalForm','${pageContext.request.contextPath}/whatIf/graph/${partyId}')">
