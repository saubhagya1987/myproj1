      			...
      			<x:choose>
			       ...
			       <x:when select="$item/@QuestionType = '85013'">		
			            ...
			            <li class="clearfix rel">
			              ...
			              <div>
			              	...
			              	<x:if select="$item/IsReadOnly = '1'">
			                	<input type="text" disabled class="fixed_txt_box answers required digits" id="text__${count.index}" name="text__${count.index}" value="${goalMap[attributeCodeId]}" />
			                </x:if>
			                <x:if select="$item/IsReadOnly = '0'">
			                	<input type="text" class="common_input2 answers required digits" id="text__${count.index}" value="${goalMap[attributeCodeId]}" name="text__${count.index}" />
			                </x:if>
			              </div>                 
			            </li>	
			        </x:when>	
					...
					<x:when select="$item/@QuestionType = '85016'">
		              <li class="list_space clearfix rel">
		                <label class="form_label"><x:out select="QuestionText" /></label>
		                <div class="spinner_T_V">
		                  <div class="value-spinner">
		                    <input id="spinner_${count.index}" name="spinner_${count.index}" value="${goalMap[attributeCodeId]}"  class="spinner answers required digits">
		                  </div>
		                 </div>
		               </li>
					   <script type="text/javascript">
								...
								<li class="clearfix rel">
									<div>
										...
										<input type="text" class="common_input2 answers"
											id="autoCity__${count.index}" name="autoCity__${count.index}"  value="${goalMap[attributeCodeId]}"/>
									</div>
								</li>
						<script type="text/javascript">			           
        ...
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            <li class="fl list"><a href="#" class="anch save"><span class="txt">Save</span></a></li>
           	<li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('travelVacationPlanId','${cancel}')"><span class="txt">Cancel</span></a></li>
