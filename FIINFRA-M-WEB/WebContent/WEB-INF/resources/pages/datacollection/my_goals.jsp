     ...
     <core:set var="goalClass" value="${goal.key}"/>
     	...
     	<div id="education">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-educational-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		...
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
	   		</ul>
     		</core:forEach>
      </div>
      </div>
      ...
      <core:if test="${fn:containsIgnoreCase(goalClass, 'travel')}">
     	<div id="traval_vacations">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-travel-vacation-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for car goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'car')}">
     	<div id="car">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-car-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for property goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'property')}">
     	<div id="property">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-property-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for special goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'special')}">
     	<div id="special">
	  		...
	  		<core:forEach items="${goal.value}" varStatus="index" var="goalData">
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-special-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      	 	<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for other goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'other')}">
     	<div id="other_goal">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-other-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      	   <li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for business goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'Buisness')}">
     	<div id="business">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-business-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
      ...
      <!-- for wedding goal -->
       <core:if test="${fn:containsIgnoreCase(goalClass, 'Marriage')}">
     	<div id="wedding">
	  		...
	  		<core:set var="goalId" value="${goalData.id}"/>
	   		<ul class="reset clearfix record">
	      		<li class="first"><a href="${pageContext.request.contextPath}/futureFinancialDc/edit-wedding-goal/${goalData.id}/${partyId}">${goalData.goalName}</a></li>
	      		<li class="second"><fmt:formatDate value="${goalData.createdDate}" pattern="dd-MMM-yyyy"/></li>
	      		<li class="third">${goalData.goalStartYear}</li>
	      		<li class="fourth"><span class="cost">${goalData.goalAmountPv}</span><span class="unit"> lacs</span></li>
	      		<li class="fifth"><a href="javascript:void(0)" onclick="javascript:doConfirm('${pageContext.request.contextPath}/futureFinancialDc/deleteGoal/${goalData.id}/${partyId}')"><div class="delete"></div></a></li>
