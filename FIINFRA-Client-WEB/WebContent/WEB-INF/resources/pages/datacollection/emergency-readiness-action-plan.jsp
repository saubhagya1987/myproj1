...
<div class="wrapper" id="emergency_readiness"> 
  ...
  <section class="main"> 
     ...
     <ul><li><img src="${pageContext.request.contextPath}/resources/images/asset_allocation_shares.png" width="41" height="40" alt="">
          <span>Shares</span></li>
          <li><img src="${pageContext.request.contextPath}/resources/images/asset_allocation_property.png" width="41" height="40" alt="">
          ...
          <div class="emergency_readiness_action_plan_bx">
            ...
            <ul class="reset clearfix emergency_readiness_action_plan_bx_ul">
              ...
              <li class="input_two fl">
                <div class="title_input_one"> DEBTS </div>
            ...
            </ul>       <ul class="reset clearfix emergency_readiness_action_plan_bx_ul">
              <li class="input_one fl">
                <div class="input_counter_parent rupee">
                  <input type="text" class="input_range_counter" id="d_payment" value="6">
                  <span class="unit dynamic">lacs</span> </div>
