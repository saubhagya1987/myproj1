    ...
    <div class="container">
      ...
      <div class=" col-md-3 sidebar-offcanvas" role="navigation" style="padding-left:10px;" >
            <div class="list-group">
                ...
                <a href="pingdelivery_report.html" class="list-group-item">Ping Delivery Report</a> 
                <a href="pingmisreport.html" class="list-group-item"><strong>Ping MIS Report </strong></a>  
...
<tr>
  <th width="12%"  class="thead"><a href="#">Partner Name</a></th>
  <th width="12%"  class="thead"><a href="#">Recipient </a></th>
  <th width="11%"  class="thead"><a href="#"> Name</a></th>
  <th width="7%" class="thead"> <a href="#">Ping Delivery Count </a></th>
</tr></thead>
<tbody>
<tr>
  <td > Pradip Kumar  </td>
  <td><i class="clienticon"></i>Client </td>
  <td> Sachin</td>
  <td>56</td>
</tr>
<tr >
  <td> Ameer Khan </td>
  <td><i class="pclienticon"></i>PClient </td>
  <td>Mohan</td>
  <td> 3</td>
</tr>
<tr>
  <td> Sachin Khedekar </td>
  <td><i class="opportunityicon"></i>Opportunity</td>
  <td>Rahul</td>
  <td>10</td>
</tr>
<tr >
