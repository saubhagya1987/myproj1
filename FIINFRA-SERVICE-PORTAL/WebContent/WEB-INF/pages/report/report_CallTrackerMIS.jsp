   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Call Tracker MIS</a>
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getCallTrackerMIS(${sessionScope.userSession.partyId});resetVal();">
								</a> 
								</div>
							</div> 
							</div>
...
<script src="<%=request.getContextPath()%>/js/jquery-1.9.1.js"></script> 
  ...
  function getCallTrackerMIS(partyid){
	...
	var url="Rpt_SP_CallTrackerMIS&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";
	 callReport(url);
	var actionByUserID = ${sessionScope.userSession.userId};
	var sourceModule='CRM Reports';
	var sourceScreen='Call Tracker MIS';
  ...
  $(document).ready(function(){
	  $('#SPCallTrackerMISReportLink').css('font-weight','bold');
	  bupartyName();
  });
