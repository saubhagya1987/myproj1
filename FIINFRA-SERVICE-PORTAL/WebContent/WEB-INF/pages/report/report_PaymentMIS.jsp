...
<!-- Search start-->
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<a href="#" style="color: #fff;">
									<input type="button" class="btn btn-xs btn-primary " value="Show" title="Show" alt="Show" onClick="getPaymentMIS(${sessionScope.userSession.userId},${sessionScope.userSession.partyId});resetVal();"></a>
			</div>
							</div> 
						</div> 
						<div class="space-2"></div>	
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	function getPaymentMIS(userid,partyid)
	{
		var userId =userid;
		...
		EndDate1 = mn+"-"+day+"-"+yr;
		  ...
		  url="Rpt_SP_PaymentMISReport&rs:Command=Render&rc:Parameters=false&userId="+userId+"&PartnerID="+PartnerId+"&OrderStatus="+OrderStatus+"&StartDate="+StartDate1+"&EndDate="+EndDate1+"&loggedpartyId="+partyid+"";
			callReport(url);

		  var actionByUserID = userid;
		  var sourceModule='Subscription Reports';
		  var sourceScreen='Payment MIS Report';
...
function addcodevalueDescription()
{
   ...
   function resetVal()
  {
   ...
   $(document).ready(function(){
	$('#SPPaymentMISReport').css('font-weight','bold');
