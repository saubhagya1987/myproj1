			    ...
			    <li class="clearfix">
			      ...
			      <div class="range_parent">
			        <div class="scale clearfix">
			          ...
			          <div id="98047"></div>
			          <div class="counter_parent rupee">
			            <input type="text" id="98047_payment" name="98047_payment" class="range_counter Number" />
			            <span class="unit">%</span> </div>
			        </div>
			      </div>
			    </li>
	                	...
	                	<x:choose>           		
	                		...
	                		<x:when select="$item/@QuestionType = '85010'">
		                		<div class="scale_range"> <span class="low extrem"><x:out select="$item/Scale/Min_Value" /></span> <span class="high extrem"><x:out select="$item/Scale/Max_Value" /></span>
		                  		...
		                  		<div class="counter_parent rupee  Number1 required">
			...
			<section class="common_footer_actions">
				<div id="main_actions" class="clearfix">
					<ul class="reset clearfix fr btn_grup3">
						...
						<li class="fl list"><a href="#" class="anch cancel" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection');"><span class="txt">Cancel</span></a></li>
...
// 									}
									var amountIn = ${questDetail.attributeRefferenceValue} / 1000;
									if(amountIn <= 100){
										$('#select_${questDetail.questionId}').val("K");										
									} else {
