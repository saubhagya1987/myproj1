               	...
               	<x:choose>           		
             		...
             		<x:when select="$item/@QuestionType = '85005'">
			            ...
			            <li class="clearfix">
			              ...
			              <label class="form_label"><x:out select="QuestionText" />
			               <textarea id="<x:out select="$item/@AttributeCodeId" />" value="" name="<x:out select="$item/@AttributeCodeId" />"  rows="5" cols="40" style="margin-top: 69px; margin-left: 535px;" class="answer"></textarea>
			              </label> <!-- </div> -->
			             </li></div>
			       </x:when>
			...
			<section class="common_footer_actions">
				<div id="main_actions" class="clearfix">
					<ul class="reset clearfix fr btn_grup3">
						<li class="fl list"><a href="#" class="anch save saveCfsEmergencyReadinessLink" ><span class="txt">Save</span></a></li>
					...
					<ul class="reset clearfix fr btn_grup2">
						<li class="fl list"><a href="#" onclick="uploadNote(${partyId},'/partner/datacollection/emergency-readiness/${partyId}');" class="anch add_note"><span class="txt">Notes</span></a></li>
						<li class="fl list"><a href="#" onclick="uploadDocument(${partyId},'/partner/datacollection/emergency-readiness/${partyId}');" class="anch add_doc"><span class="txt">Documents</span></a></li>
					</ul>
					<ul class="reset clearfix fl btn_grup1">
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/emergency-readiness-analysis/${partyId}');" class="anch analysis cfsEmergencyReadinessAnalysisLink"><span class="txt">Analysis</span></a></li>
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/suggestion/emergency-readiness/${partyId}');" class="anch suggeset cfsEmergencyReadinessSuggesstionLink"><span class="txt">Suggestion</span></a></li>
						<li class="fl list ${isDataSaved }"><a href="#" onclick="checkData('${pageContext.request.contextPath}/actionplan/emergency-readiness-action-plan/${partyId}');" class="anch action_plan emergencyReadinessActionPlanLink"><span class="txt">Action Plan</span></a></li>
					</ul>
				</div>
...
$(document).ready(function(){
	$(".toggle-inner").css("width", 157);
//    $(".single_select").removeClass("not_applicable");
	$(".box").hide();
	/*  var labelName =$(".not_applicable").find(".label").attr('name');
	...
	if(pieces != ""){
		for(var i=0;i<pieces.length;i++){
			if(pieces[i]=="saveCfsEmergencyReadinessLink"){
