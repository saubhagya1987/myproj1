...
$(document).ready(function(){	
	$("#frmPersonalAccidentInsurance").validate({
		  ignore:'', //i.e. do not ignore hidden elements 
		 });
 getAutoComplete();	
 $('.wrapper').addClass("edit_personal_accident_wrapper add_assets");
...
function saveInsurance(url, isNew) {
	$("#associatedFamilyPartyId").val('');
	 ...
	 $("#frmPersonalAccidentInsurance").attr("action", url);
	 
	 var partyId='${partyId}';
	 if(isNew) {
		 $("#returnUrl").val('insurance/personal-accident-insurance-details-add/'+partyId);
	 } else {		 
		 $("#returnUrl").val('insurance/general-insurance-details/personalAccident/'+partyId);
	 }
	 
	 if($('#frmPersonalAccidentInsurance').validate().form()){
		 checkDataFinal();		 
			if(initialData.toString() == finalData.toString()){ 
				...
				if(cnt == 1) {
					cnt++;					
	 				$("#frmPersonalAccidentInsurance").submit();
...
<div class=""> 
  ...
  <section class="main"> 
  <form action="" id="frmPersonalAccidentInsurance" name="frmPersonalAccidentInsurance" commandName="insuranceData">
...
<c:choose>
    ...
    <div id="page_loader"></div>
      <section class="in_content common_in_content"> 
        ...
        <section id="edit_personal_accident_insurance" class="in_content common_in_content clearfix">
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="#" class="anch cancel" onClick="CancelPage('${pageContext.request.contextPath}/insurance/general-insurance-details/personalAccident/${partyId}')"><span class="txt">Cancel</span></a></li>
          </ul>
        </div>
