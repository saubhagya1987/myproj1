...
<!-- Search start-->
	...
	function getPingDND(buid,partyid)
	{
		  ...
		  url="Rpt_SP_PingDNDReport&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"&nodeId="+nodeId+"";
		
		 callReport(url);
		  
		  var actionByUserID = ${sessionScope.userSession.userId};
		  var sourceModule='Ping Report';
		  var sourceScreen='Ping DND Report';
   ...
   function chkform()
   {
  	if (document.getElementById("quickSearchpart").value === "" ) 
     {
  	...
  	else
  		{
  			...
  			getPingDND('${sessionScope.userSession.buId}','${sessionScope.userSession.partyId}');
         ...
         function resetVal()
        {
         ...
         $(document).ready(function(){
        	 $('#SPPingDNDListReportLink').css('font-weight','bold');
