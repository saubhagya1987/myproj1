  ...
  <jsp:include page="../common/footer.jsp" />
	...
	<script type="text/javascript">
	 ...
	 $(document).ready(function(){
		 $('#SPclientGoalDetailReportLink').css('font-weight','bold');
		 
   	});

	
	function getClientGoalDetails(buid,partyid)
	{
	     var buId=buid;
	  ...
	  var url="Rpt_SP_ClientGoalDetailsReport&rs:Command=Render&rc:Parameters=false&buId="+buId+"&partnerId="+PartnerId+"&partyId="+ClientpartyId+"&loggedpartyId="+partyid+"&nodeId="+nodeId+"";

	  callReport(url);
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='Goal Reports';
	  var sourceScreen='Client Goal Details Report';
	  var objectName = 'BussinessUnitID::'+buId+', PartnerPartyID::'+PartnerId+', ClientPartyID::'+ClientpartyId+', LoggedInPartyID::'+partyid;
		  ...
		  function chkform()
	       {
	      	if (document.getElementById("quickSearchpart").value === "" ) 
	         {
	      	...
	      	else
	      		{
	      			...
	      			getClientGoalDetails(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});
