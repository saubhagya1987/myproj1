...
<jsp:include page="../common/footer.jsp" />
	...
	function getClientUnitHoldReport(partyid){
		
		var as_at_date = $('#datepicker').val();
		var ClientpartyId = $('#quickSearchHidden').val();
			var partner_id = partyid;
				...
				as_at_date = mn+"-"+day+"-"+yr;
				  ...
				  url ="ClientUnitHoldReport&rs:Command=Render&rc:Parameters=false&Party_id="+ClientpartyId+"&AsOnDate="+as_at_date+"&partnerId="+partner_id+"&loggedpartyId="+partner_id+"";
				  callReport(url);
				  var actionByUserID = ${sessionScope.userSession.userId};
				  var sourceModule='Client level';
				  var sourceScreen='Client Unit Hold Report';
				  var objectName ='ClientpartyId::'+ClientpartyId+',AsOndate::'+as_at_date+',PartnerId::'+partner_id+',loggedpartyId::'+partnerId;
				  $.ajax({
						 type :'POST',
...
//			 					        	partyId=ui.item.value;
   ...
   function chkform()
   {
  	if (document.getElementById("quickSearch").value === "" ) 
     {
  	...
  	{
  		getClientUnitHoldReport(${sessionScope.userSession.partyId});
   ...
   $(document).ready(function(){
	   $('#ClientUnitHoldingLink').css('font-weight','bold');
