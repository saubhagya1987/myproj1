      		...
      		<x:forEach select="$output/Section/Question" var="item" varStatus="count">
			            ...
			            <li class="clearfix rel">
			              ...
			              <div>
			                ...
			                <x:if select="$item/IsReadOnly = '0'">
			                	<input type="text" class="common_input2 answers required" id="text__${count.index}" value="${goalMap[attributeCodeId]}" name="text__${count.index}"  <x:if select="$item/@AttributeCodeId = '100015'">  maxlength="9" </x:if> />
			                </x:if>
			              </div>                 
			            </li>	
			        </x:when>	
     			<x:when select="$item/@QuestionType = '85999'">
								<li class="clearfix rel">
									...
									<!-- <script>
										var attrId = ${count.index};
										if(attrId==14) {
											var state  = '${goalMap[attributeCodeId]}';
											$("#stateIdHidden").val(state);
										}
									</script> -->
								</li>
					</x:when>
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup3">
            ...
            <li class="fl list"><a href="javascript:void(0);" class="anch cancel" onclick="doValidate('propertyGoalFormId','${cancel}')"><span class="txt">Cancel</span></a></li>
