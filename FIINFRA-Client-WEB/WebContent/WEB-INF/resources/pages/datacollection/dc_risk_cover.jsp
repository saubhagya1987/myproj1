				...
				<c:when test="${assumption.assumptionCodeId eq '98021' or assumption.assumptionCodeId eq '98046' or assumption.assumptionCodeId eq '98019' or assumption.assumptionCodeId eq '98001'}">				
					<script>
						if("${assumption.assumptionCodeId}" == 98046) {
							createSlider('#${assumption.assumptionCodeId}', ${(assumption.valueStartRange) / 100000}, ${(assumption.valueEndRange) / 100000}, 1, '#${assumption.assumptionCodeId}_payment');
							$('#${assumption.assumptionCodeId}').slider( "option", "value", ${(assumption.assumptionValue) / 100000});
							$('#${assumption.assumptionCodeId}_payment').val(${(assumption.assumptionValue) / 100000});
						}
						else {
...
$(".Advice_Assump_Menu .save").click(function(){
	...
	var updatedAssumptionData = "98021:" + $("#98021_payment").val() + "," + "98046:" + ($("#98046_payment").val() * 100000) + "," + "98019:" + $("#98019_payment").val() + "," + "98001:" + $("#98001_payment").val(); 
	$.ajax({
		type : "POST",
		url : url,
		data : {
