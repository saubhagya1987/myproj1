...
<body>
    		...
    		<div class="main-content">
	  		...
	  		<div class="container-body">
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									...
									<div id="jqGrid_container">
       	  								...
       	  								<div id="toreload1" class="col-md-12 tabular_break_word">
       	  									<table id="grid-table"></table>
											<div id="grid-pager"></div>
										</div>
										
									<input type="text" name="listSize" id="listSize" value="${listSize}">
								</div>	
        			...
        			<div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
						...
						<div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
							<input type="text" name="newSize" id="newSize" value="${listSize}">
	...
	<script>
		...
		function loadPreprintedForm(){
			$.ajax({
				type : "POST",
				url : $('#contextPath').val()+'/et/openEtForm.htm?fpActionPlanId='+fpActionPlanId,
 ...
 <script type="text/javascript">
		...
		function loadGrid(grid_data){	
			...
			$('#toreload1').empty();
			$('#toreload1').append('<table id="grid-table"></table><div id="grid-pager"></div>');
