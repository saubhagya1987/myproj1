...
<head>
<style>
#assetProperty label[for="currentValue"]{top: -44px;width: 40%;}
</style>	
<script>
$(function() {
...
$(document).ready(function(){
	...
	$( document ).ajaxComplete(function() {
		var x = document.getElementById("assetProperty");
    	 ...
    	 if($('#assetProperty').validate().form()){
    		 if(checkChangeData()){
	    		 ...
	    		 {	
	    			 $("#saveAdd").addClass("inactiveLink");
	    			$("#saveClose").addClass("inactiveLink");
	    			$('#assetProperty').attr('action', '${pageContext.request.contextPath}/assets/saveAndCloseAssets');
		  			$('#assetProperty').submit();
	    		 	cntrSave++;
	    		 }
    		 }
...
selectBox1.selectOption('${assetProperty.ownerPartyId}');

$("li").addClass("rel");

$("#assetProperty").validate({ignore:'', rules:{currentValue:{min:1}}});
  ...
  <section class="main">    
    ...
    <jsp:include page="../layout/dc_submenu.jsp"></jsp:include>
      <section class="in_content common_in_content"> 
        ...
        <%-- <form:form id="assetCancel" method="POST" action="">
        </form:form> --%>
          <form:form id="assetProperty" method="POST" action="${pageContext.request.contextPath}/assets/saveAssets">
          ...
          <input type="hidden" id="assetPage" name="assetPage" value="5"/>
          <div id="dialog1" class="common_dialog" style="text-align: center;"> </div>
          <div id="page_loader"></div>
        <section id="add_assets_property" class="in_content common_in_content clearfix">
          ...
          <div class="continer_parent">
            <div class="fd_box dynamic_box northspace6">
              <ul class="clearfix head_title first_level_heading reset">
                ...
                <li class="title_two label fl">Property Name</li>
                <li class="title_three label fl">Year Bought In</li>
                <!-- <li class="title_four label fl">Growth Rate(%)</li> -->
                 <li class="title_five label fl">Property Value</li>
              ...
              <ul class="clearfix data_inputs first_level_inputs reset">
                ...
                <li class="input_two label fl">
                  <input type="text" class="common_input required" name="assetName" value="${assetProperty.assetName}"/>
                </li>
                <li class="input_three label fl">
                  <input type="text" class="common_input datepicker fl required date" readonly="readonly" name="investmentDate" value="${assetProperty.commcementDate}"/>
                </li>
                <%-- <li class="input_four label fl">
                  <input type="text" class="common_input required number" name="interestRate" value="${assetProperty.interestRate}"/>
                </li> --%>
                <li class="input_five label fl">
                  <input type="text" class="common_input required mynumber" id="currentValue" name="currentValue" value="${assetProperty.currentBalance}"/>
                </li>
         ...
         <c:otherwise>
         	<p>No Linked Goals To Property</p>
         </c:otherwise>
         </c:choose>
                  <div class="clr"></div>
                </li>
      ...
      <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
           ...
           <li class="fl list"><a href="#" class="anch cancel" id="cancel" onclick="doAction('${pageContext.request.contextPath}/assets/assetDetails/${partyId}/0?assetPage=5');"><span class="txt">Cancel</span></a></li>
          </ul>
        </div>
