...
#analysis_report_content .client_details .category_ul .second .category { background:url(${pageContext.request.contextPath}/resources/images/risk_analysis_icon.png) no-repeat center center #fff }
...
.secondary_heading { background:<%=colorCode%> url(${pageContext.request.contextPath}/resources/images/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:29px; text-align:center; font-size: 20px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 26px; }
