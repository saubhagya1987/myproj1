   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Subscription MIS Report </a>
...
<!-- Search start-->
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getSubscriptionMIS(${sessionScope.userSession.userId},${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	function getSubscriptionMIS(userid,partyid)
	{
		{
		  ...
		  url="Rpt_SP_SubscriptionMISReport&rs:Command=Render&rc:Parameters=false&userId="+userId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+partyid+"";
		 
			callReport(url);
		  var actionByUserID = userid;
		  var sourceModule='Subscription Reports';
		  var sourceScreen='Subscription MIS Report';
		  var objectName = 'UserID::'+userId+', StartDate::'+StartDate1+', EndDate::'+EndDate1+', loggedpartyId:: '+partyid ;
		  $.ajax({
				 type :'POST',
...
// 					        	partyId=ui.item.value;
   ...
   function resetVal()
  {
   ...
   $(document).ready(function(){
	   $('#SPSubscriptionMISReport').css('font-weight','bold');
