...
<!-- 		<s:hidden type="hidden" id="profile" value="%{output.profile}" ></s:hidden> -->
		...
		<input type="hidden" id="section" value="${sessionScope.Section1}"/>
<body >
 ...
 <h1> ${output.salutation} ${output.opportunityName}</h1>
  ...
  <div class="col-md-12" style="margin:20px 0 20px 12px;">
		   <div class="col-md-3">
               <div class="dcbox">
               <center>
                 <a><img src="<%=request.getRequestURL().toString().replace(request.getRequestURI().substring(0),request.getContextPath())%>/images/${sessionScope.userSession.themeName}/dc1op.png"></a>
               </center><br>
           ...
           <div class="col-md-3"> 
              <div class="dcbox"><br>          
              <center> 
                <a ><img src="<%=request.getRequestURL().toString().replace(request.getRequestURI().substring(0),request.getContextPath())%>/images/${sessionScope.userSession.themeName}/dc4op.png" ></a>
              </center> 
     		...
     		<div class="col-md-3">
               <div class="dcbox">
                <center>
                  <a ><img src="<%=request.getRequestURL().toString().replace(request.getRequestURI().substring(0),request.getContextPath())%>/images/${sessionScope.userSession.themeName}/dc3op.png"   ></a>
                </center><br>
          ...
          <div class="col-md-3">
              <div class="dcbox">
               <center> 
                 <a ><img src="<%=request.getRequestURL().toString().replace(request.getRequestURI().substring(0),request.getContextPath())%>/images/${sessionScope.userSession.themeName}/dc2op.png"></a>
               </center><br>
...
<c:set var="theString" scope="session" value="${sessionScope.Section}"/>
...
<!-- 								<img src="<%=request.getRequestURL().toString().replace(request.getRequestURI().substring(0),request.getContextPath())%>/images/outputaxis/down.png" alt="" class="up"> -->
				...
				<div class="suggestion"  style="width:49%;height: 340px;">
								<p class="heading">Our Suggestion</p>
								<c:choose >						
										    <c:when test="${output.percentGoalReachable<=99}">
										    	<p class="suggestion_text" style="text-align: left;!important">
										    	<ui><li>Additional regular investment of Rs.<span class="red">${output.regularInvestmentRetirement}</span> to be made now till retirement.</li></ui>
										    	<ui><li>If you want to start at a later date, amount required will be:</li></ui>
										    	<c:if test="${not empty (output.retirementList)}">
										    		<table border="2" align="center">
										    			<th>Start Year</th>
										    			<th>Regular Investment Amount Required</th>
										    			<th>Lumpsum Amount Required</th>
										    			<c:forEach items="${output.retirementList}" var="retirementList">
										    				<tr>
										    					<td>${retirementList.productName}</td>
										    					<td>${retirementList.minSipAmount}</td>
										    					<td>${retirementList.minLumpSumAmount}</td>
										    				</tr>
										    			</c:forEach>
										    		</table>
										    	</c:if>
