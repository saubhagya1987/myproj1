...
<!-- 				</div> -->
 		<div class="topmenu">
			...
			<%-- <a href="<%=request.getContextPath()%>/addOpportunity.htm?partyId="+partyId id="newOpportunityLink"> --%>
			...
			<a href="<%=request.getContextPath()%>/bulkUploadOpportunity.htm" id="importOpportunityLink">
			<input type="button" class="btn btn-sm btn-success " value="  Import Opportunities" title="Import Opportunities"></a>
			<input data-params="{}" type="button" class="btn btn-sm btn-danger" id="deleteOpportunityLink" value=" Delete Opportunities"  title="Delete Opportunities" onclick="deleteOpportunities();">
		...
		*/
		...
		jQuery(grid_selector).jqGrid({
			...
			colModel:[
				...
				{name:'partyId', index:'partyId', width:25,formatter:imageFormat,formatoptions:{baseLinkUrl:'${pageContext.request.contextPath}/addOpportunity.htm?partyId='}},
				{name:'name',index:'name', width:120,formatter:viewProfile},
				//{name:'rmHead',index:'rm',width:120,},
				{name:'city',index:'city',width:120,},
				{name:'createdDate',index:'date',sortable:false, width:100,},
				...
				{name:'stage',index:'stage',sortable:false, width:75},
