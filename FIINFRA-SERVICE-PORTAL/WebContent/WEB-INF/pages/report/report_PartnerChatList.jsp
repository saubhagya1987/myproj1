   ...
   <!--div starts  -->      
     <div class="row"> 
  		...
  		<div class="list-group">
        		<a class="list-group-item active" href="#">Partner Chat List</a>
...
<!-- Search start-->
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPartnerChatList(${sessionScope.userSession.buId},${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	function getPartnerChatList(buId,partyid)
	{
	  var buId=buId;
	...
	var url="Rpt_SP_PartnerChatList&rs:Command=Render&rc:Parameters=false&buID="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";
	callReport(url);
	
	 
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='CRM Reports';
	  var sourceScreen='Partner Chat List';
...
function getCurrentDate(){
   ...
   $(document).ready(function(){
  	 $('#SPPartnerChatListReportLink').css('font-weight','bold');
