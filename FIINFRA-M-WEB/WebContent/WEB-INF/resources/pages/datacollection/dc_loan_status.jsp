...
<div id="emergency_readiness">
  ...
  <section class="main"> `
	...
	<section class="common_unit_selector"><ul class="clearfix reset"><li class="k" onClick="changeScale('k')"><span class="unit">K</span></li><li class="lac unit_selected" onClick="changeScale('lac')"><span class="unit">Lac</span></li><li class="cr" onClick="changeScale('cr')"><span class="unit">Cr</span></li></ul><p>All figures are in :</p></section>
			...
			<section class="common_footer_actions">
				<div id="main_actions" class="clearfix">
					<ul class="reset clearfix fr btn_grup3">
						<li class="fl list"><a href="#" class="anch save saveCfsLoanStatusLink" ><span class="txt">Save</span></a></li>
					...
					<ul class="reset clearfix fr btn_grup2">
						<li class="fl list inactiveLink"><a href="#" onclick="uploadNote(${partyId},'/partner/datacollection/loan-status/${partyId}');" class="anch add_note"><span class="txt">Notes</span></a></li>						
						<li class="fl list"><a href="#" onclick="uploadDocument(${partyId},'/partner/datacollection/loan-status/${partyId}');" class="anch add_doc"><span class="txt">Documents</span></a></li>
					</ul>
					<ul class="reset clearfix fl btn_grup1">
						<li class="fl list inactiveLink ${isDataSaved}"><a href="#" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/loan-status-analysis/${partyId}');" class="anch analysis cfsLoanStatusAnalysisLink"><span class="txt">Analysis</span></a></li>
						<li class="fl list inactiveLink ${isDataSaved}"><a href="#" onclick="checkData('${pageContext.request.contextPath}/partner/datacollection/suggestion/loan-status/${partyId}');" class="anch suggeset cfsLoanStatusSuggesstionLink"><span class="txt">Suggestion</span></a></li>
						<li class="fl list inactiveLink ${isDataSaved}"><a href="#" onclick="errorMsg();" class="anch action_plan"><span class="txt">Action Plan</span></a></li>
					</ul>
				</div>
...
$(document).ready(function(){	
	...
	if(pieces != ""){
		for(var i=0;i<pieces.length;i++){
			if(pieces[i]=="saveCfsLoanStatusLink"){
