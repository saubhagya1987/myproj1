...
<div id="">
	...
	<div class="main-content">
     ...
     <form class="form-horizontal" id="otherGoalForm" name="otherGoalForm" action="<c:url value="/futureFinancialDc/saveOtherGoal" />" method="POST">
        			...
        			<x:when select="$item/@QuestionType = '85017'">	
			          <div class="form-group">
			              <label class="col-sm-3 no-padding-right"><x:out select="QuestionText" /> </label>
			              	<div class="col-sm-7">
			              <textarea id="Other_Goal_txt_editor"  class="answers required" name="text__${count.index}"  cols="45" rows="5">${goalMap[attributeCodeId]}</textarea>		              				            
			            </div>	
			            </div>
			        </x:when>
	...
	<div class="row">
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs inactiveLink"
				onclick="doValidate('frmEductionGoal','${pageContext.request.contextPath}/partner/datacollection/${partyId}/${headerName}/2')">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-4 col-xs-4 test">
				<button
					class="btn btn-app btn-transparent btn-xs analysis " onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/analysis/other/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-search bigger-200"></i> Analysis
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs suggeset " onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/analysis/suggestion/other/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-lightbulb-o bigger-200"></i> Suggestion
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs action_plan " onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/actionplan/goal/other/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-hand-o-up bigger-200"></i> Action Plan
				</button>
			</div>
			<div class="col-sm-3 col-xs-4">
				<button class="btn btn-app btn-transparent btn-xs " onclick="uploadNote(${goalId},${partyId},'/futureFinancialDc/edit-other-goal/${goalId}/${partyId}');">
					<c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/edit-other-goal/${goalId}/${partyId}"/>
					<i class="ace-icon fa fa-file-code-o bigger-200"></i> Notes
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs dcAddNewDocumentLink"
					onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/partner/addDocument${docUrl}');">
			...
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveEditOtherGoalLink save">
