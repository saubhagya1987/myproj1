	...
	<div class="row">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-4 col-xs-4 test">
				<button
					class="btn btn-app btn-transparent btn-xs analysis " onclick="doValidate('specialGoalForm','${pageContext.request.contextPath}/analysis/special/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-search bigger-200"></i> Analysis
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs suggeset " onclick="doValidate('specialGoalForm','${pageContext.request.contextPath}/analysis/suggestion/special/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-lightbulb-o bigger-200"></i> Suggestion
				</button>
				<button
					class="btn btn-app btn-transparent btn-xs action_plan " onclick="doValidate('specialGoalForm','${pageContext.request.contextPath}/actionplan/goal/special/${partyId}/${goalId}')">
					<i class="ace-icon fa fa-hand-o-up bigger-200"></i> Action Plan
				</button>
			</div>
			<div class="col-sm-3 col-xs-4">
				<button class="btn btn-app btn-transparent btn-xs " onclick="uploadNote(${goalId},${partyId},'/futureFinancialDc/edit-special-goal/${goalId}/${partyId}');">
				      <c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/edit-special-goal/${goalId}/${partyId}"/>
			...
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveEditSpecialGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('specialGoalForm','${cancel}')">
