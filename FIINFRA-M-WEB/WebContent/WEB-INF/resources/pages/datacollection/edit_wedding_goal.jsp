...
<div id="">
  ...
  <div class="main-content-inner">
     ...
     <form class="form-horizontal" id="frmWeddingGoal" name="frmWeddingGoal" action="<c:url value="/futureFinancialDc/saveWeddingGoal" />" method="POST">
      <div class="page-content"> 
      <input type="hidden" name="hiddenGoalName" id="hiddenGoalName" value="${goalName}"  class="required"/> 
      	...
      	<x:parse xml="${sectionData}" var="output" />
      		...
      		<x:forEach select="$output/Section/Question" var="item" varStatus="count">
      			...
      			<x:choose>
					...
					<x:when select="$item/@QuestionType = '85004'">
			  		...
			  		<script type="text/javascript">			           
					   		...
					   		if(dropDownName == '#brand_1' || dropDownName == '#brand_2'||dropDownName == '#brand_3') {
			      ...
			      <x:when select="$item/@QuestionType = '85009'">
							...
							<c:choose> <c:when test='${count.index == 4 }'>Number1</c:when><c:when test='${count.index != 4 }'>Number1</c:when></c:choose>" />
			    				...
			    				if(sliderVar=="#slider_5" || sliderVar=="#slider_6")
			    				{
        ...
        <div class="col-sm-1 col-xs-3">
         ...
         <div class="col-sm-10 col-xs-6">
          ...
          <div class="col-sm-4 col-xs-4 test">
            <button class="btn btn-app btn-transparent btn-xs analysis " onclick="doValidate('frmWeddingGoal','${pageContext.request.contextPath}/analysis/wedding/${partyId}/${goalId}')"> <i class="ace-icon fa fa-search bigger-200"></i> Analysis </button>
            <button class="btn btn-app btn-transparent btn-xs suggeset " onclick="doValidate('frmWeddingGoal','${pageContext.request.contextPath}/analysis/suggestion/wedding/${partyId}/${goalId}')"> <i class="ace-icon fa fa-lightbulb-o bigger-200"></i> Suggestion </button>
            <button class="btn btn-app btn-transparent btn-xs action_plan " onclick="doValidate('frmWeddingGoal','${pageContext.request.contextPath}/actionplan/goal/wedding/${partyId}/${goalId}')"> <i class="ace-icon fa fa-hand-o-up bigger-200"></i> Action Plan </button>
          </div>
          <div class="col-sm-3 col-xs-4">
            <button class="btn btn-app btn-transparent btn-xs " onclick="uploadNote(${goalId},${partyId},'/futureFinancialDc/edit-wedding-goal/${goalId}/${partyId}');"> <i class="ace-icon fa fa-file-code-o bigger-200"></i> Notes </button>
            <c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/edit-wedding-goal/${goalId}/${partyId}"/>
            <button class="btn btn-app btn-transparent btn-xs dcAddNewDocumentLink" onclick="doValidate('frmWeddingGoal','${pageContext.request.contextPath}/partner/addDocument${docUrl}');"> <i class="ace-icon fa fa-newspaper-o bigger-200"></i> Doc </button>
          </div>
          <div class="col-sm-4 col-xs-4">
            <button class="btn btn-app btn-transparent btn-xs saveEditWeddingGoalLink save" > <i class="ace-icon fa fa-save bigger-200"></i> Save </button>
            <button class="btn btn-app btn-transparent btn-xs"  onclick="doValidate('frmWeddingGoal','${cancel}')"> <i class="ace-icon fa fa-close bigger-200"></i> Cancel </button>
            <a href="#"><button class="btn btn-app btn-transparent btn-xs inactiveLink"> <i class="ace-icon fa fa-forward bigger-200"></i> Skip </button></a>
          </div>
          <div class="col-sm-1 col-xs-0"></div>
          <div class="col-sm-1 col-xs-0"></div>
        </div>
        <div class="col-sm-1 col-xs-3">
          <button class="btn btn-app btn-transparent btn-xs inactiveLink onclick="location.href="${pageContext.request.contextPath}${next}" > <i class="ace-icon fa fa-long-arrow-right bigger-240"></i> Next </button>
        </div>
