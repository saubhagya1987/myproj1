...
<!-- Search start-->
  ...
  <jsp:include page="../common/footer.jsp" />
	...
	function getPartnerContactList(buid,partyid){
	  ...
	  var url="Rpt_SP_PartnerContactList&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&loggedpartyId="+loggedpartyId+"&nodeId="+nodeId+"";
	  callReport(url);
	  var actionByUserID = ${sessionScope.userSession.userId};
	  var sourceModule='CRM Reports';
	  var sourceScreen='Partner Contact List';
	  var objectName ='BusinessUnit::'+buId+',PartnerId::'+PartnerId+',ClientId::'+ClientId+',loggedpartyId::'+loggedpartyId+',nodeId::'+nodeId;
	  $.ajax({
			 type :'POST',
		  ...
		  function chkform()
		   {
		  	if (document.getElementById("quickSearchpart").value === "" ) 
		     {
		  	...
		  	else
		  		{
					...
					getPartnerContactList('${sessionScope.userSession.buId}','${sessionScope.userSession.partyId}');
		       ...
		       $(document).ready(function(){
	            $('#SPPartnerContactListReportLink').css('font-weight','bold');
	            }); 
