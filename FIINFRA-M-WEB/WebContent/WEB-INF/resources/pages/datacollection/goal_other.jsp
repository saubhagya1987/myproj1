        ...
        <x:forEach select="$output/Section/Question" var="item" varStatus="count">
      			...
      			<x:choose>
        			...
        			<x:when select="$item/@QuestionType = '85017'">	
			              ...
			              <label class="col-sm-3 no-padding-right" for="text__${count.index}"><x:out select="QuestionText"/> </label>
			              <div class="col-sm-7">
										...
										<div class="range_parent">
											<div class="scale clearfix">
												...
												<div class="col-sm-5 col-xs-6">
													...
													<input type="text" id="sliderValue_${count.index}" name="sliderValue_${count.index}" class="col-xs-9 range_counter answers required"/>
													<x:if select="$item/Scale/IsCurrency != '0'">
	...
	<div class="row">
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/futureFinancialDc/target-corpus-goal/${partyId}')">
		...
		<div class="col-sm-10 col-xs-6">
			...
			<div class="col-sm-3 col-xs-4">
				<button class="btn btn-app btn-transparent btn-xs inactiveLink">
				 <c:set var="docUrl" value="?partyId=${partyId}&url=/futureFinancialDc/other-goal/${partyId}"/>
			...
			<div class="col-sm-4 col-xs-4">
				<button
					class="btn btn-app btn-transparent btn-xs saveAddOtherGoalLink save">
					<i class="ace-icon fa fa-save bigger-200"></i> Save
				</button>
				<button class="btn btn-app btn-transparent btn-xs"
					onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/partner/datacollection/${partyId}/<%=request.getSession().getAttribute("headerName")%>/2')">
		...
		<div class="col-sm-1 col-xs-3">
			<button class="btn btn-app btn-transparent btn-xs"
				onclick="doValidate('otherGoalForm','${pageContext.request.contextPath}/partner/datacollection/${partyId}/${headerName}/2')">
