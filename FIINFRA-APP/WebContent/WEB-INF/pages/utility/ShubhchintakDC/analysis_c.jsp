...
#analysis_report_content .client_details .category { height:105px; width:105px; border:2px solid <%=colorCode%>; -moz-border-radius: 69px; -webkit-border-radius: 69px; border-radius: 69px; -moz-box-shadow: 0px 0px 4px 2px #9F9F9F; -webkit-box-shadow: 0px 0px 4px 2px #9F9F9F; box-shadow: 0px 0px 4px 2px #9F9F9F;}
...
#analysis_report_content .client_details .category_ul li { margin-left:5% }
...
#analysis_report_content .client_details .category_ul .third  .cat_name{text-indent: -6px;}
...
#analysis_report_content .client_details .category_ul .second .category { background:url(${pageContext.request.contextPath}/images/diyimages/risk_profile_report.png) no-repeat center center #fff;background-size: 60%; }
#analysis_report_content .client_details .category_ul .third .category { background: url(${pageContext.request.contextPath}/images/diyimages/emergency_report.png) no-repeat center center #fff }
#analysis_report_content .client_details .category_ul .fourth .category { background: url(${pageContext.request.contextPath}/images/diyimages/risk_planning_report.png) no-repeat center center #fff }
#analysis_report_content .client_details .category_ul .fifth .category { background: url(${pageContext.request.contextPath}/images/diyimages/succsession_report.png) no-repeat center center #fff }
...
.analysis_report_c .heading1{margin: 10px 0 0 0;line-height: 24px;text-align: left;font-size: 20px;color: #FFF;font-family: "Aller Bold";width: 393px;text-shadow: 1px 2px 1px #0B2B3C;}
...
.rupee_big{color:#FFF; margin-left:5px;background:url(${pageContext.request.contextPath}/images/diyimages/rupee_thumb.png) no-repeat;width:10px; height:16px;display: inline-block;}
...
<body>
<div class="wrapper analysis_report_c">
  <div class="header clearfix">
    <div class="desc_heading fl">
      <h2 class="head_txt1">Steps to financial freedom </h2>
    </div>
    <h1 class="heading1 fl">Analysis Report - Goals, Emergency, Risk & Succession</h1>
  </div>
  <div class="content" id="analysis_report_content">
    <div class="box1 ifa_details clearfix">
      ...
      <%-- <div class="fr logo"><img src="${pageContext.request.contextPath}/images/diyimages/ifa_logo.png"/> </div> --%>
...
#goals_my_dreams .goal_asset_desc .goal_val .heading { font-size:11px; text-align:center; margin:5px 12px 0 0;color:#fff;float:none }
...
#goals_my_dreams.content{height: 1024px;}
.analysis_report_c .page_heading{margin: 10px 0 0 0;line-height: 44px;text-align: center;font-size: 23px;}
.secondary_heading { background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:34px; text-align:center; font-size: 23px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 31px; }
...
#emergency-planning .variable .secondary_heading{background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:34px; text-align:center; font-size: 23px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 31px; }
#emergency-planning .box3.report .secondary_heading{background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:34px; text-align:center; font-size: 23px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 31px; margin:0 0 10px 0 }
#goals_my_dreams .report .secondary_heading { background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:29px; text-align:center; font-size: 20px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 26px; }
...
#emergency-planning .report .rs_symbol { display: inline-block; background: url(${pageContext.request.contextPath}/images/diyimages/theme_color_ruppe.png) no-repeat center center; width: 8px; height: 11px; margin: 0px 1px 0 3px; vertical-align: -2px; }
#emergency-planning .btm_logo { background: url(${pageContext.request.contextPath}/images/diyimages/finfra-logo-small.png) no-repeat center center; width: 76px; height: 20px; margin:-30px 0 0 21px }
...
<c:choose>
	<c:when test="${fn:contains(fpSection, '39001')}">
	  ...
	  <br><p class="secondary_heading">Emergency Planning</p>
	</c:when>
	<c:otherwise>
		<div class="header clearfix">
	    <div class="desc_heading fl">
...
<div class="content" id="emergency-planning">
        ...
        <li>
          <div class="emergency_category rel clearfix">
            ...
            <div class="emergency_action fr">
              ...
              <p class="txt">Set aside ${suggestionData.age} months worth of expenses. Build this corpus - keep them in bank accounts or liquid mutual funds. Ensure joint holding with someone who you trust.</p>
            </div>
          </div>
        </li>
      </ul>
        ...
        <li>
          <div class="emergency_category rel clearfix">
            ...
            <div class="emergency_action fr">
              ...
              Take Critical Illness Insurance for Rs. ${diffCritical} lacs <br>(${suggestionData.expence} months income).
              </c:if>  <c:if test="${diffCritical <= 0 }">
              Excellent! You have adequate Critical Illness Insurance coverage.
              </c:if>
              <c:if test="${diffAccidental > 0}">
              <br> Take Accidental Disability Insurance for Rs. ${diffAccidental} lacs (${suggestionData.monthlyincome} months income)
               </c:if>
                <c:if test="${diffAccidental <= 0}">
  ...
  <div class="footer clearfix"  style="page-break-after:always;margin-top:-50px;" >
  	<div class="btm_logo fl"  style="display:none;
    background: url(/FIINFRA-M-WEB/images/diyimages/finfra-logo-small.png) no-repeat center center;  width: 76px;  height: 20px;  margin: -30px 0 0 21px;"></div>
    <!-- <div class="fl footer_tagline">True Friends of New Investors</div> -->
    <div class="fr page_no">(<span class="no">${pageNumber}</span>)</div>
...
.header { height:65px; background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; }
.desc_heading { background: #FFF; width: 366px; height: 50px; margin: 7px 0 0; border-radius: 0 30px 30px 0; -moz-border-radius: 0 30px 30px 0; -webkit-border-radius: 0 30px 30px 0; }
#succession_planning.content { height:990px }
.footer { height:18px; background:#c0c0c0 }
.page_heading { color: #FFF; font-size: 23px; font-family: "Aller Bold"; line-height: 63px; text-align: center; width: 393px; text-shadow: 1px 2px 1px #0B2B3C; }
.footer { font-size:12px; font-family: "Aller Bold"; line-height: 19px; }
.footer .footer_tagline { margin:0 0 0 22px; }
...
#succession_planning .action { height:294px; width:294px; border:2px solid <%=colorCode%>; -moz-border-radius: 172px; -webkit-border-radius: 172px; border-radius: 172px; -moz-box-shadow: 0px 9px 18px -4px #828282, -37px 0 0 163px #FFF inset; -webkit-box-shadow: 0px 9px 18px -4px #828282, -37px 0 0 163px #FFF inset; box-shadow: 0px 9px 18px -4px #828282, -37px 0 0 163px #FFF inset; position: absolute; left:165px; z-index:100; background-color: #FFF; }
...
#succession_planning .action .txt { font-family: "Aller Bold"; font-size: 15px; margin: 11px 0 0 54px; width: 234px; height: 202px; border-radius: 0 0 115px 71px; color: <%=colorCode%>; line-height:23px;padding: 0 0 0 5px; }
...
#succession_planning .container_ul li { margin:10px 0 0}
/***Goals My Dreams Ends***/
...
<div class="header clearfix">
  ...
  <br><p class="secondary_heading" style="margin-top: -10px;">Succession Planning</p>
