...
<div id="">
	...
	<div class="main-content">
     ...
     <form class="form-horizontal" id="travelVacationPlanId" name="travelVacationPlan" action="<c:url value="/whatIf/save-travel-vacation-goal" />" method="POST">
    ...
    <%--   <section class="common_footer_actions">
        <div id="main_actions" class="clearfix">
          <ul class="reset clearfix fr btn_grup2">
            ...
            <li class="fl list"><a href="javascript:void(0)" class="anch cancel" onclick="doValidate('travelVacationPlanId','${pageContext.request.contextPath}/whatIf/graph/${partyId}')" style="margin-right: 260px;"><span class="txt">Cancel</span></a></li>
          </ul>
        </section> --%>
	...
	<div class="col-sm-4 col-xs-4 "></div>
		<div class="col-sm-3 col-xs-4">
			...
			<button class="btn btn-app btn-transparent btn-xs cancel"
				onclick="doValidate('travelVacationPlanId','${pageContext.request.contextPath}/whatIf/graph/${partyId}')">
...
$(document).ready(function(){
	jsonPopulateAutoCompleteForCarGoalNew("${pageContext.request.contextPath}/common/codevalues?codeTypeId=CountryForGoal", '', "#autoCity__4", "autoCity__4", '');
	$("#autoCity_4").removeClass("required");		
 ...
 // auto slider   
     ...
     // on load change html
	   	...
	   	if($("#hiddenGoalName").val()=="" || $("#hiddenGoalName").val()==null)
	    {
	    	...
	    	var loanReq = parseFloat(amt) - parseFloat(dp); 
	    	//loanReq = Math.round(loanReq * 10) / 10;
	    	//var loanReq = parseInt($("#text__7").val()) - parseInt($("#sliderValue_8").val()); 
		 	if(loanReq > 0){
