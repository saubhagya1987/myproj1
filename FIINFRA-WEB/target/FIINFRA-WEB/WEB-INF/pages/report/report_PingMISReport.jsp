...
<div class="close" style="margin-right:10px;"><a onClick="popup('popUpDiv')" href="#"><img alt="" src="images/btn_close.gif" /></a></div>
   ...
   <!--div starts  -->      
     <div class="row">
			...
			<div class=" col-md-3 sidebar-offcanvas" role="navigation"
				...
				<div class="list-group">
					<a class="list-group-item active" href="#">Ping Reports</a> <a
						href="loadreportPingDelivery.htm" class="list-group-item"
						id="pingDeliveryReportLink"> Ping Delivery Report </a> <a
						href="loadPingMISReport.htm" class="list-group-item" href="#"
						id="pingMISReportLink"><strong>Ping MIS Report</strong></a> <a
						href="loadPingDNDList.htm" class="list-group-item" href="#"
						id="pingDNDReportLink">Ping DND List</a>
				</div>
			...
			<div class="col-md-9"> 
				...
				<div class="list-group">
					<a class="list-group-item active" href="#">Ping MIS Report</a>
					<div class="list-group-item">
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getPingMIS(${sessionScope.userSession.partyId},${sessionScope.userSession.buId},${sessionScope.nodeId});resetVal();">
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>	
	...
	function getPingMIS(partyid,buid,nodeId)
	{
		  var buId = buid;
		 ...
		 /*  var reportLink= $('#abc').val(); */
		  url="PingMISReport&rs:Command=Render&rc:Parameters=false&buID="+buId+"&partnerId="+PartnerId+"&partyId="+ClientId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"&nodeId="+nodeId+"";
		  callReport(url);
