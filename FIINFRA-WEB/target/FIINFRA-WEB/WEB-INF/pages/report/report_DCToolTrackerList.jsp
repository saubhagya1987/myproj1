  		...
  		<%-- <jsp:include page="DataCollectionSidebar.jsp" />  --%>
			...
			<div class=" col-md-3 sidebar-offcanvas" role="navigation"
				...
				<div class="list-group">
					<a class="list-group-item active" href="#">Data Collection Reports</a>

					 		  <a href="loadreportDCTrackerList.htm"  class="list-group-item" id="dcToolTrackerListLink"><strong> DC Tracker List</strong></a>
						     <a href="loadreportProductRecommendationReport.htm"class="list-group-item" href="#" id="ProductRecommendationReportLink">Product Recommendation Report</a> 	
              				<!-- <a href="loadreportExecutedRevenueMIS.htm" class="list-group-item" href="#">Estimated Revenue MIS</a> -->
				</div>
				<!-- <div class="list-group">
					...
					<input  type="hidden" id="abc"   placeholder="Quick Search" style="width: 300px;">
						...
						<div class="space-2"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
								<input type="button" class="btn btn-xs btn-primary" value="Show" title="Show"alt="Show" onClick="getDCTrackerList(${sessionScope.userSession.partyId},${sessionScope.userSession.buId},${sessionScope.nodeId});resetVal();">
								</div>
							</div> 
						</div> 
						<div class="space-2"></div>
...
<footer>
  <jsp:include page="../common/footer.jsp" />
	...
	<script src="<%=request.getContextPath()%>/js/jquery-ui.js"></script> --%>
	 ...
	 function getDCTrackerList(partyid,buId,nodeId){
	...
	/*   var reportLink= $('#abc').val(); */
	  url ="DCTrackerList&rs:Command=Render&rc:Parameters=false&buId="+buId+"&partnerId="+partyid+"&partyId="+ClientpartyId+"&opportunitystatus="+CurrentStage+"&StartDate="+StartDate1+"&EndDate="+EndDate1+"&loggedpartyId="+partyid+"&nodeId="+nodeId+"";
	  callReport(url);
	...
	/*   $("#gen2").html(reportview2);  */
	  ...
	  var sourceModule='Rpt_PP_DCTrackerList';
	  var sourceScreen='Rpt_PP_DCTrackerList';
	  var objectName = 'BussinessUnitID::'+buId+', PartnerPartyID::'+partyid+', ClientPartyID::'+ClientpartyId+', OpportunityStatusId::'+CurrentStage+', StartDate::'+StartDate+',  EndDate::'+EndDate+', LoggedInPartyID::'+partyid+',NodeId'+nodeId;
	  $.ajax({
			 type :'POST',
