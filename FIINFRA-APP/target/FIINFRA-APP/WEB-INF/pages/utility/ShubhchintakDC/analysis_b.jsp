...
#analysis_report_content .client_details .category_ul .second .category { background:url(${pageContext.request.contextPath}/images/diyimages/risk_profile_report.png) no-repeat center center #fff;}
...
#goals_my_dreams .report .secondary_heading { background:<%=colorCode%> url(${pageContext.request.contextPath}/images/diyimages/<%=imagePath%>) no-repeat center right;background-size: 754px auto; height:34px; text-align:center; font-size: 23px; color: #FFF; font-family: "Aller Bold"; text-shadow: 1px 2px 1px #0B2B3C; line-height: 31px; }
.theme_color { color:<%=colorCode%> }
