...
<div id="common_popup_div" style="display: none">
	...
	<img  id="centerLoadingImage"
		...
		<h4 style="position:absolute;top: 54%; left: 26%; color: #0e0828; display: none;" id="analysiReportGenerationMsg">Please wait ..the report is being generated. Do not close or refresh the window.</h4>
	<!-- 	</div> -->
