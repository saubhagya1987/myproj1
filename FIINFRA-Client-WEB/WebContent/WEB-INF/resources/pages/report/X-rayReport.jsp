...
<% 
 ...
 Integer themeId = _USER.getThemeId();
...
<title>Financial X Ray Page 1<%=themeId %></title>
...
<body>
    ...
    if(!StringUtils.isEmpty(_USER.getOwnerLogo())){
    	if(_USER.getOwnerLogo().startsWith("/")){
    		ownerLogo = baseURL+"/FIINFRA-Client-WEB/app/images"+_USER.getOwnerLogo();	
    	}
    	else{
    		ownerLogo = baseURL+"/FIINFRA-Client-WEB/app/images/"+_USER.getOwnerLogo();
    	}
