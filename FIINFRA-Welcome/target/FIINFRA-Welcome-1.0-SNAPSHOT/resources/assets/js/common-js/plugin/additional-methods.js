...
jQuery.validator.addMethod("mobileNL", function(value, element) {
	return this.optional(element) || /^(\+91[\-\s]?)?[0-9]\d{9}$/.test(value)||/^(\+[\-\s]?)?[0-9]\d{14}$/.test(value)||/^(\+[\-\s]?)?[0-9]\d{13}$/.test(value);
}, "Please specify valid mobile number");
jQuery.validator.addMethod("phNumber", function(value, element) {
	return this.optional(element) || /^(\+91[\-\s]?)?[0-9]\d{10}$/.test(value);
