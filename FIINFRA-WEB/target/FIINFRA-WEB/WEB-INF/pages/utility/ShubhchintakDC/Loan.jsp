...
<title>Financial Plan - Current Financial Status: Loan Status</title>
...
// 				alert(e);
			...
			if(qFL.trim()=="Yes")
			{
				...
				//alert('in no')
			//alert('in no');
			$('input[name=94164]').prop( "checked", false );	
	        		 ...
	        		 var isDatacollectionChange = $('#dcInputDocId_AnalysisReport').val();
	        			...
	        			if(isDatacollectionChange==0 || isDatacollectionChange=='0' || isDatacollectionChange==null )
	 	        		 ...
	 	        		 $('.ZebraDialog').css('top','250px');
	        				...
	        				showAlertMessage("Success", "<br/>Loan Section saved successfully.Please click on Generate Report if you would like to see the revised Analysis Report.", "confirmation", doNothing);		
	        			}
	        	 }	       
	         }
	         });
