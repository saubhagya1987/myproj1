   ...
   <!--div starts  -->      
     <div class="row">
  		...
  		<div class="list-group"> 
        		<a class="list-group-item active" href="#">Goal Type & Duration Wise Details </a>
			 ...
			 <form onsubmit="return false" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								...
								<input type="submit" class="btn btn-xs btn-primary" value="Show" title="Show" alt="Show" onClick="getGoalTypeDurtnMIS(${sessionScope.userSession.partyId});resetVal();">
								</a>
								</div>
							</div> 
						</div> 
...
<!-- Center part End -->          
  ...
  function getGoalTypeDurtnMIS(partyid){
...
url="Rpt_SP_GoalTypeAndDurationWise&rs:Command=Render&rc:Parameters=false&buId="+buId+"&StartDate="+StartDate+"&EndDate="+EndDate+"&loggedpartyId="+loggedpartyId+"";
callReport(url);

  var actionByUserID = ${sessionScope.userSession.userId};
  var sourceModule='Goal Reports';
  var sourceScreen='Goal Type And Duration Wise';
  ...
  $(function() {
	 ...
	 /*   function showSelectFrom(){
		 ...
		 $(document).ready(function(){
			  $('#SPGoalTypeDurationwisedetailsReportLink').css('font-weight','bold');
