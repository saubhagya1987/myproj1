...
function generateReport(reportName,partyId) {
	...
	var reporturl ="birtreport.htm?ReportName="+reportName+"&ReportFormat=html&Partyid=" + partyId + "&StartDate="+StartDate + "&EndDate="+EndDate + "&status="+opportStatus;
...
function downgetClientGoalDetailSt(format){
	...
	var reporturl ="birtreport.htm?ReportName="+reportName+"&ReportFormat=html&PartnerId=" + partyId + "&ClientpartyId=" + ClientpartyId + "&AsOnDate="+EndDate;
...
//	$("#reportview").html("Loading...<br><img src='images/loading.gif' align='middle' >");
	...
	function downClientTxnHistory(format,partyId){
		...
		var reporturl ="birtreport.htm?ReportName="+reportName+"&ReportFormat="+format+"&PartnerId=" + partyId+"&ClientpartyId=" + ClientpartyId +"&StartDate="+StartDate+ "&EndDate="+EndDate+ "&TransactionTypeId=" + TxnType + "&Issuerid="+Issuer ;
...
//		var TxnFlow = $('#txnflow').val();
		...
		var reporturl ="birtreport.htm?ReportName="+reportName+"&ReportFormat=html&PartnerId=" + partyId+"&ClientpartyId=" + ClientpartyId +"&StartDate="+StartDate+ "&EndDate="+EndDate+ "&TransactionTypeId=" + TxnType + "&Issuerid="+Issuer ;
